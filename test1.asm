...
main(int argc, char *argv[])
{
  ...
  13:	68 b8 07 00 00       	push   $0x7b8
  18:	6a 01                	push   $0x1
  1a:	e8 71 04 00 00       	call   490 <printf>
  printf(1, "Before fp: %d\n", countfp());
  1f:	e8 8f 03 00 00       	call   3b3 <countfp>
  24:	83 c4 0c             	add    $0xc,%esp
  27:	50                   	push   %eax
  28:	68 d2 07 00 00       	push   $0x7d2
  2d:	6a 01                	push   $0x1
  2f:	e8 5c 04 00 00       	call   490 <printf>
	
  parent_fp = countfp();
  34:	e8 7a 03 00 00       	call   3b3 <countfp>
  39:	89 c3                	mov    %eax,%ebx

  pid = fork();
  3b:	e8 cb 02 00 00       	call   30b <fork>
  if(pid == 0){
  40:	83 c4 10             	add    $0x10,%esp
  43:	85 c0                	test   %eax,%eax
  45:	75 35                	jne    7c <main+0x7c>
    child_fp = countfp();
  47:	e8 67 03 00 00       	call   3b3 <countfp>
	printf(1, "fp p, c: %d %d\n", parent_fp, child_fp);
  4c:	50                   	push   %eax
    child_fp = countfp();
  ...
  50:	29 f3                	sub    %esi,%ebx
	printf(1, "fp p, c: %d %d\n", parent_fp, child_fp);
  52:	68 e1 07 00 00       	push   $0x7e1
  57:	6a 01                	push   $0x1
  59:	e8 32 04 00 00       	call   490 <printf>
    if(parent_fp - child_fp == 68)
  5e:	83 c4 10             	add    $0x10,%esp
  61:	83 fb 44             	cmp    $0x44,%ebx
  64:	74 3f                	je     a5 <main+0xa5>
      printf(1, "[Test 1] pass\n\n");
    else
      printf(1, "[Test 1] fail\n\n");
  66:	50                   	push   %eax
  67:	50                   	push   %eax
  68:	68 01 08 00 00       	push   $0x801
  6d:	6a 01                	push   $0x1
  ...
  77:	e8 97 02 00 00       	call   313 <exit>
    ...
    wait();
  7c:	e8 9a 02 00 00       	call   31b <wait>
	sleep(10);
  81:	83 ec 0c             	sub    $0xc,%esp
  84:	6a 0a                	push   $0xa
  86:	e8 18 03 00 00       	call   3a3 <sleep>
	printf(1, "After fp: %d\n", countfp());
  8b:	e8 23 03 00 00       	call   3b3 <countfp>
  90:	83 c4 0c             	add    $0xc,%esp
  93:	50                   	push   %eax
  94:	68 11 08 00 00       	push   $0x811
  99:	6a 01                	push   $0x1
  ...
  a5:	52                   	push   %edx
  a6:	52                   	push   %edx
  a7:	68 f1 07 00 00       	push   $0x7f1
  ac:	6a 01                	push   $0x1
  ae:	e8 dd 03 00 00       	call   490 <printf>
  b3:	83 c4 10             	add    $0x10,%esp
  b6:	eb bf                	jmp    77 <main+0x77>
  b8:	66 90                	xchg   %ax,%ax
  ba:	66 90                	xchg   %ax,%ax
  bc:	66 90                	xchg   %ax,%ax
  be:	66 90                	xchg   %ax,%ax
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 28 08 00 00 	jmp    *0x828(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 1f 08 00 00       	mov    $0x81f,%edx
        while(*s != 0){
 ...
 631:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 30 0b 00 00    	mov    %edx,0xb30
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 30 0b 00 00    	mov    %edx,0xb30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 30 0b 00 00    	mov    0xb30,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 30 0b 00 00    	mov    %edx,0xb30
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 30 0b 00 00 34 	movl   $0xb34,0xb30
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 34 0b 00 00       	mov    $0xb34,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 7a2:	00 00 00 
    if(p->s.size >= nunits){
