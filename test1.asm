...
main(int argc, char *argv[])
{
  ...
  28:	50                   	push   %eax
  29:	68 02 08 00 00       	push   $0x802
  2e:	6a 01                	push   $0x1
  30:	e8 8b 04 00 00       	call   4c0 <printf>
	
  parent_fp = countfp();
  35:	e8 a9 03 00 00       	call   3e3 <countfp>
  3a:	89 c3                	mov    %eax,%ebx
  parent_pp = countpp();
  3c:	e8 b2 03 00 00       	call   3f3 <countpp>
  41:	89 c6                	mov    %eax,%esi
  parent_ptp = countptp();
  43:	e8 b3 03 00 00       	call   3fb <countptp>
  48:	89 45 e4             	mov    %eax,-0x1c(%ebp)

  pid = fork();
  4b:	e8 eb 02 00 00       	call   33b <fork>
  if(pid == 0){
  50:	83 c4 10             	add    $0x10,%esp
  53:	85 c0                	test   %eax,%eax
  55:	75 5c                	jne    b3 <main+0xb3>
    child_fp = countfp();
  57:	e8 87 03 00 00       	call   3e3 <countfp>
  5c:	89 c7                	mov    %eax,%edi
	child_pp = countpp();
  5e:	e8 90 03 00 00       	call   3f3 <countpp>
  63:	89 45 e0             	mov    %eax,-0x20(%ebp)
	child_ptp = countptp();
  66:	e8 90 03 00 00       	call   3fb <countptp>
	printf(1, "fp p, c: %d %d\n", parent_fp, child_fp);
  6b:	57                   	push   %edi
  6c:	53                   	push   %ebx
  ...
  6d:	29 fb                	sub    %edi,%ebx
	printf(1, "fp p, c: %d %d\n", parent_fp, child_fp);
  6f:	68 11 08 00 00       	push   $0x811
  74:	6a 01                	push   $0x1
	child_ptp = countptp();
  76:	89 45 dc             	mov    %eax,-0x24(%ebp)
	printf(1, "fp p, c: %d %d\n", parent_fp, child_fp);
  79:	e8 42 04 00 00       	call   4c0 <printf>
	printf(1, "pp+ptp p, c: %d %d\n", parent_pp + parent_ptp, child_pp + child_ptp);
  7e:	8b 55 e0             	mov    -0x20(%ebp),%edx
  81:	03 75 e4             	add    -0x1c(%ebp),%esi
  84:	03 55 dc             	add    -0x24(%ebp),%edx
  87:	52                   	push   %edx
  88:	56                   	push   %esi
  89:	68 21 08 00 00       	push   $0x821
  8e:	6a 01                	push   $0x1
  90:	e8 2b 04 00 00       	call   4c0 <printf>
    if(parent_fp - child_fp == 68)
  95:	83 c4 20             	add    $0x20,%esp
  98:	83 fb 44             	cmp    $0x44,%ebx
  9b:	74 33                	je     d0 <main+0xd0>
  ...
  ab:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  ae:	e8 90 02 00 00       	call   343 <exit>
  }
  else{
    wait();
  b3:	e8 93 02 00 00       	call   34b <wait>
	printf(1, "After fp: %d\n", countfp());
  b8:	e8 26 03 00 00       	call   3e3 <countfp>
  bd:	52                   	push   %edx
  be:	50                   	push   %eax
  bf:	68 55 08 00 00       	push   $0x855
  c4:	6a 01                	push   $0x1
  ...
  d7:	6a 01                	push   $0x1
  d9:	e8 e2 03 00 00       	call   4c0 <printf>
  de:	83 c4 10             	add    $0x10,%esp
  e1:	eb cb                	jmp    ae <main+0xae>
  e3:	66 90                	xchg   %ax,%ax
  e5:	66 90                	xchg   %ax,%ax
  e7:	66 90                	xchg   %ax,%ax
  e9:	66 90                	xchg   %ax,%ax
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 6c 08 00 00 	jmp    *0x86c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 63 08 00 00       	mov    $0x863,%edx
        while(*s != 0){
