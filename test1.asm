...
main(int argc, char *argv[])
{
  ...
  13:	68 88 07 00 00       	push   $0x788
  18:	6a 01                	push   $0x1
  1a:	e8 41 04 00 00       	call   460 <printf>
	
  parent_fp = countfp();
  1f:	e8 5f 03 00 00       	call   383 <countfp>
  ...
  30:	75 32                	jne    64 <main+0x64>
    child_fp = countfp();
  32:	e8 4c 03 00 00       	call   383 <countfp>
	printf(1, "fp p, c: %d %d\n", parent_fp, child_fp);
  37:	50                   	push   %eax
    child_fp = countfp();
  ...
  3b:	29 f3                	sub    %esi,%ebx
	printf(1, "fp p, c: %d %d\n", parent_fp, child_fp);
  3d:	68 a2 07 00 00       	push   $0x7a2
  42:	6a 01                	push   $0x1
  44:	e8 17 04 00 00       	call   460 <printf>
    if(parent_fp - child_fp == 68)
  49:	83 c4 10             	add    $0x10,%esp
  4c:	83 fb 44             	cmp    $0x44,%ebx
  4f:	74 1d                	je     6e <main+0x6e>
      printf(1, "[Test 1] pass\n\n");
    else
      printf(1, "[Test 1] fail\n\n");
  51:	50                   	push   %eax
  52:	50                   	push   %eax
  53:	68 c2 07 00 00       	push   $0x7c2
  58:	6a 01                	push   $0x1
  ...
  62:	eb 05                	jmp    69 <main+0x69>
    ...
    wait();
  64:	e8 82 02 00 00       	call   2eb <wait>
  }
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 dc 07 00 00 	jmp    *0x7dc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba d2 07 00 00       	mov    $0x7d2,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 e4 0a 00 00 e8 	movl   $0xae8,0xae4
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf e8 0a 00 00       	mov    $0xae8,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 772:	00 00 00 
    if(p->s.size >= nunits){
