...
main(int argc, char* argv[])
{
  ...
  int numfp = countfp();
  20:	e8 9e 03 00 00       	call   3c3 <countfp>
  25:	89 45 dc             	mov    %eax,-0x24(%ebp)
  int numvp = countvp();
  28:	e8 9e 03 00 00       	call   3cb <countvp>
  2d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  int numpp = countpp();
  30:	e8 9e 03 00 00       	call   3d3 <countpp>
  35:	89 c3                	mov    %eax,%ebx
  int numptp = countptp();
  37:	e8 9f 03 00 00       	call   3db <countptp>

  sbrk(4096);
  3c:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  int numptp = countptp();
  43:	89 c7                	mov    %eax,%edi
  sbrk(4096);
  45:	e8 61 03 00 00       	call   3ab <sbrk>

  int numfpa = countfp();
  4a:	e8 74 03 00 00       	call   3c3 <countfp>
  4f:	89 45 d8             	mov    %eax,-0x28(%ebp)
  int numvpa = countvp();
  52:	e8 74 03 00 00       	call   3cb <countvp>
  57:	89 45 e0             	mov    %eax,-0x20(%ebp)
  int numppa = countpp();
  5a:	e8 74 03 00 00       	call   3d3 <countpp>
  5f:	89 c6                	mov    %eax,%esi
  int numptpa = countptp();
  61:	e8 75 03 00 00       	call   3db <countptp>
  
  printf(1, "ptp: %d %d\n", numptp, numptpa);
  66:	50                   	push   %eax
  67:	57                   	push   %edi
  68:	68 da 07 00 00       	push   $0x7da
  6d:	6a 01                	push   $0x1
  ...
  77:	56                   	push   %esi
  78:	53                   	push   %ebx
  79:	68 e6 07 00 00       	push   $0x7e6
  7e:	6a 01                	push   $0x1
  80:	e8 1b 04 00 00       	call   4a0 <printf>

  if((numvp == numpp) && (numvpa == numppa) && (numfp - numfpa == 1))
  85:	83 c4 10             	add    $0x10,%esp
  88:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
  8b:	75 10                	jne    9d <main+0x9d>
  8d:	39 75 e0             	cmp    %esi,-0x20(%ebp)
  90:	75 0b                	jne    9d <main+0x9d>
  92:	8b 55 dc             	mov    -0x24(%ebp),%edx
  95:	2b 55 d8             	sub    -0x28(%ebp),%edx
  98:	83 fa 01             	cmp    $0x1,%edx
  9b:	74 17                	je     b4 <main+0xb4>
    printf(1, "[Test 0] pass\n\n");
  else
    printf(1, "[Test 0] fail\n\n");
  9d:	83 ec 08             	sub    $0x8,%esp
  a0:	68 01 08 00 00       	push   $0x801
  a5:	6a 01                	push   $0x1
  a7:	e8 f4 03 00 00       	call   4a0 <printf>
  ac:	83 c4 10             	add    $0x10,%esp

  exit();
  af:	e8 6f 02 00 00       	call   323 <exit>
    printf(1, "[Test 0] pass\n\n");
  b4:	50                   	push   %eax
  b5:	50                   	push   %eax
  b6:	68 f1 07 00 00       	push   $0x7f1
  bb:	6a 01                	push   $0x1
  bd:	e8 de 03 00 00       	call   4a0 <printf>
  c2:	83 c4 10             	add    $0x10,%esp
  c5:	eb e8                	jmp    af <main+0xaf>
  c7:	66 90                	xchg   %ax,%ax
  c9:	66 90                	xchg   %ax,%ax
  cb:	66 90                	xchg   %ax,%ax
  cd:	66 90                	xchg   %ax,%ax
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 11 08 00 00       	mov    $0x811,%edx
        while(*s != 0){
