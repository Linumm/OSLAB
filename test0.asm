...
main(int argc, char* argv[])
{
  ...
  int numfp = countfp();
  20:	e8 be 03 00 00       	call   3e3 <countfp>
  25:	89 45 e0             	mov    %eax,-0x20(%ebp)
  int numvp = countvp();
  28:	e8 be 03 00 00       	call   3eb <countvp>
  2d:	89 c6                	mov    %eax,%esi
  int numpp = countpp();
  2f:	e8 bf 03 00 00       	call   3f3 <countpp>
  34:	89 c3                	mov    %eax,%ebx
  int numptp = countptp();
  36:	e8 c0 03 00 00       	call   3fb <countptp>
  ...
  sbrk(4096);
  45:	e8 81 03 00 00       	call   3cb <sbrk>

  int numfpa = countfp();
  4a:	e8 94 03 00 00       	call   3e3 <countfp>
  4f:	89 45 dc             	mov    %eax,-0x24(%ebp)
  int numvpa = countvp();
  52:	e8 94 03 00 00       	call   3eb <countvp>
  57:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  int numppa = countpp();
  5a:	e8 94 03 00 00       	call   3f3 <countpp>
  5f:	89 c7                	mov    %eax,%edi
  int numptpa = countptp();
  61:	e8 95 03 00 00       	call   3fb <countptp>
  
  printf(1, "ptp: %d %d\n", numptp, numptpa);
  66:	8b 55 d8             	mov    -0x28(%ebp),%edx
  69:	50                   	push   %eax
  6a:	52                   	push   %edx
  6b:	68 fa 07 00 00       	push   $0x7fa
  70:	6a 01                	push   $0x1
  72:	e8 49 04 00 00       	call   4c0 <printf>
  printf(1, "fp: %d %d\n", numfp, numfpa);
  77:	83 c4 20             	add    $0x20,%esp
  7a:	ff 75 dc             	push   -0x24(%ebp)
  7d:	ff 75 e0             	push   -0x20(%ebp)
  80:	68 06 08 00 00       	push   $0x806
  85:	6a 01                	push   $0x1
  87:	e8 34 04 00 00       	call   4c0 <printf>
  printf(1, "vp: %d %d\n", numvp, numvpa);
  8c:	ff 75 e4             	push   -0x1c(%ebp)
  8f:	56                   	push   %esi
  90:	68 11 08 00 00       	push   $0x811
  95:	6a 01                	push   $0x1
  ...
  9f:	57                   	push   %edi
  a0:	53                   	push   %ebx
  a1:	68 1c 08 00 00       	push   $0x81c
  a6:	6a 01                	push   $0x1
  a8:	e8 13 04 00 00       	call   4c0 <printf>

  if((numvp == numpp) && (numvpa == numppa) && (numfp - numfpa == 1))
  ad:	83 c4 10             	add    $0x10,%esp
  b0:	39 de                	cmp    %ebx,%esi
  b2:	75 10                	jne    c4 <main+0xc4>
  b4:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
  b7:	75 0b                	jne    c4 <main+0xc4>
  b9:	8b 45 e0             	mov    -0x20(%ebp),%eax
  bc:	2b 45 dc             	sub    -0x24(%ebp),%eax
  bf:	83 f8 01             	cmp    $0x1,%eax
  c2:	74 17                	je     db <main+0xdb>
    printf(1, "[Test 0] pass\n\n");
  else
    printf(1, "[Test 0] fail\n\n");
  c4:	83 ec 08             	sub    $0x8,%esp
  c7:	68 37 08 00 00       	push   $0x837
  cc:	6a 01                	push   $0x1
  ...
  db:	50                   	push   %eax
  dc:	50                   	push   %eax
  dd:	68 27 08 00 00       	push   $0x827
  e2:	6a 01                	push   $0x1
  e4:	e8 d7 03 00 00       	call   4c0 <printf>
  e9:	83 c4 10             	add    $0x10,%esp
  ec:	eb e8                	jmp    d6 <main+0xd6>
  ee:	66 90                	xchg   %ax,%ax
