...
80102590:	68 e6 78 10 80       	push   $0x801078e6
...
8010267b:	68 ec 78 10 80       	push   $0x801078ec
...
8010296b:	0f b6 91 20 7a 10 80 	movzbl -0x7fef85e0(%ecx),%edx
  shift ^= togglecode[data];
80102972:	0f b6 81 20 79 10 80 	movzbl -0x7fef86e0(%ecx),%eax
  shift |= shiftcode[data];
...
80102988:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010298b:	8b 04 85 00 79 10 80 	mov    -0x7fef8700(,%eax,4),%eax
...
801029c5:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
801029c8:	0f b6 81 20 7a 10 80 	movzbl -0x7fef85e0(%ecx),%eax
...
80102f0a:	68 20 7b 10 80       	push   $0x80107b20
...
80103167:	68 24 7b 10 80       	push   $0x80107b24
...
80103221:	68 33 7b 10 80       	push   $0x80107b33
80103226:	e8 55 d1 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
8010322b:	83 ec 0c             	sub    $0xc,%esp
8010322e:	68 49 7b 10 80       	push   $0x80107b49
...
80103258:	68 64 7b 10 80       	push   $0x80107b64
...
801033fe:	68 78 7b 10 80       	push   $0x80107b78
...
801034b6:	68 7d 7b 10 80       	push   $0x80107b7d
...
801035d3:	68 82 7b 10 80       	push   $0x80107b82
...
80103602:	68 78 7b 10 80       	push   $0x80107b78
...
80103638:	68 9c 7b 10 80       	push   $0x80107b9c
...
801036e0:	00 00 00 
  initlock(&p->lock, "pipe");
801036e3:	68 bb 7b 10 80       	push   $0x80107bbb
...
80103b16:	68 c0 7b 10 80       	push   $0x80107bc0
...
80103c7f:	68 f0 7b 10 80       	push   $0x80107bf0
80103c84:	50                   	push   %eax
80103c85:	e8 d6 0d 00 00       	call   80104a60 <safestrcpy>
  p->cwd = namei("/");
80103c8a:	c7 04 24 f9 7b 10 80 	movl   $0x80107bf9,(%esp)
...
80103cc3:	68 d7 7b 10 80       	push   $0x80107bd7
...
801040dd:	68 48 7c 10 80       	push   $0x80107c48
801040e2:	e8 99 c2 ff ff       	call   80100380 <panic>
    panic("init exiting");
801040e7:	83 ec 0c             	sub    $0xc,%esp
801040ea:	68 3b 7c 10 80       	push   $0x80107c3b
...
80104220:	68 54 7c 10 80       	push   $0x80107c54
...
80104329:	68 5a 7c 10 80       	push   $0x80107c5a
8010432e:	e8 4d c0 ff ff       	call   80100380 <panic>
    panic("sleep");
80104333:	83 ec 0c             	sub    $0xc,%esp
80104336:	68 54 7c 10 80       	push   $0x80107c54
...
8010443b:	68 2f 80 10 80       	push   $0x8010802f
...
8010445c:	74 ea                	je     80104448 <procdump+0x28>
      state = "???";
8010445e:	ba 6b 7c 10 80       	mov    $0x80107c6b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104463:	83 f8 05             	cmp    $0x5,%eax
80104466:	77 11                	ja     80104479 <procdump+0x59>
80104468:	8b 14 85 cc 7c 10 80 	mov    -0x7fef8334(,%eax,4),%edx
      state = "???";
8010446f:	b8 6b 7c 10 80       	mov    $0x80107c6b,%eax
...
8010447e:	68 6f 7c 10 80       	push   $0x80107c6f
...
801044bd:	68 c1 76 10 80       	push   $0x801076c1
...
801044ea:	68 e4 7c 10 80       	push   $0x80107ce4
...
80104725:	68 ef 7c 10 80       	push   $0x80107cef
8010472a:	e8 51 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010472f:	83 ec 0c             	sub    $0xc,%esp
80104732:	68 06 7d 10 80       	push   $0x80107d06
...
8010479b:	68 0d 7d 10 80       	push   $0x80107d0d
...
80104890:	68 15 7d 10 80       	push   $0x80107d15
...
80104cbc:	8b 14 85 40 7d 10 80 	mov    -0x7fef82c0(,%eax,4),%edx
...
80104ce8:	68 1d 7d 10 80       	push   $0x80107d1d
...
80104e44:	68 c4 7d 10 80       	push   $0x80107dc4
...
80104e5c:	68 c3 7d 10 80       	push   $0x80107dc3
...
80104e71:	68 b7 7d 10 80       	push   $0x80107db7
...
80104e8f:	68 c6 7d 10 80       	push   $0x80107dc6
80104e94:	e8 e7 b4 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104e99:	83 ec 0c             	sub    $0xc,%esp
80104e9c:	68 a8 7d 10 80       	push   $0x80107da8
...
8010529d:	58                   	pop    %eax
8010529e:	5a                   	pop    %edx
8010529f:	68 c4 7d 10 80       	push   $0x80107dc4
...
801052b8:	68 c3 7d 10 80       	push   $0x80107dc3
...
{
  return scountvp();
80105a90:	e9 7b 1a 00 00       	jmp    80107510 <scountvp>
...
{
  return scountpp();
80105aa0:	e9 ab 1a 00 00       	jmp    80107550 <scountpp>
...
{
  return scountptp();
80105ab0:	e9 2b 1b 00 00       	jmp    801075e0 <scountptp>
...
80105b2e:	00 00 ef 
  initlock(&tickslock, "time");
80105b31:	68 09 7e 10 80       	push   $0x80107e09
...
80105bb4:	ff 24 85 b0 7e 10 80 	jmp    *-0x7fef8150(,%eax,4)
...
80105c95:	68 6c 7e 10 80       	push   $0x80107e6c
...
80105d27:	68 14 7e 10 80       	push   $0x80107e14
...
80105e25:	68 38 7e 10 80       	push   $0x80107e38
80105e2a:	e8 71 a8 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105e2f:	83 c4 14             	add    $0x14,%esp
80105e32:	68 0e 7e 10 80       	push   $0x80107e0e
...
80105edc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105edf:	bf 78 7f 10 80       	mov    $0x80107f78,%edi
...
80106adf:	68 e6 78 10 80       	push   $0x801078e6
...
80106bcd:	68 80 7f 10 80       	push   $0x80107f80
...
80106dfb:	68 c5 7f 10 80       	push   $0x80107fc5
...
80106e60:	68 df 7f 10 80       	push   $0x80107fdf
...
80106ee8:	68 fc 80 10 80       	push   $0x801080fc
...
80106f89:	68 fd 7f 10 80       	push   $0x80107ffd
...
80106feb:	68 15 80 10 80       	push   $0x80108015
...
801070cc:	68 31 80 10 80       	push   $0x80108031
...
8010719c:	68 42 80 10 80       	push   $0x80108042
...
8010720a:	68 4c 80 10 80       	push   $0x8010804c
...
801072a3:	68 80 80 10 80       	push   $0x80108080
...
801072d3:	68 66 80 10 80       	push   $0x80108066
...
801072f4:	0f 84 75 03 00 00    	je     8010766f <uva2ka.cold>
  return &pgtab[PTX(va)];
...
801073ad:	0f 84 c3 02 00 00    	je     80107676 <copyout.cold>
  return &pgtab[PTX(va)];
...
80107413:	0f 84 ca 00 00 00    	je     801074e3 <CoW_handler+0xe3>
...
80107428:	0f 84 a8 00 00 00    	je     801074d6 <CoW_handler+0xd6>
  return &pgtab[PTX(va)];
8010742e:	89 f2                	mov    %esi,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107430:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80107435:	c1 ea 0a             	shr    $0xa,%edx
80107438:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
8010743e:	8d bc 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%edi
	panic("CoW_handler: No proc");

  if((pte = walkpgdir(p->pgdir, (void*)fva, 0)) == 0)
80107445:	85 ff                	test   %edi,%edi
80107447:	0f 84 89 00 00 00    	je     801074d6 <CoW_handler+0xd6>
	panic("CoW_handler: pte should exist");
  if(!(*pte & PTE_P)){
8010744d:	f6 07 01             	testb  $0x1,(%edi)
80107450:	0f 84 9a 00 00 00    	je     801074f0 <CoW_handler+0xf0>
...
80107459:	81 c6 00 00 00 80    	add    $0x80000000,%esi
8010745f:	56                   	push   %esi
80107460:	e8 0b b4 ff ff       	call   80102870 <get_refc>
  if(refc == 1){ // cause: parent try to write on read-only page
80107465:	83 c4 10             	add    $0x10,%esp
80107468:	83 f8 01             	cmp    $0x1,%eax
8010746b:	74 1b                	je     80107488 <CoW_handler+0x88>
	*pte |= PTE_W;
  }
  else if(refc > 1){ // cause: child needs copy page
8010746d:	7f 21                	jg     80107490 <CoW_handler+0x90>
...
80107482:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	*pte |= PTE_W;
80107488:	83 0f 02             	orl    $0x2,(%edi)
8010748b:	eb e2                	jmp    8010746f <CoW_handler+0x6f>
8010748d:	8d 76 00             	lea    0x0(%esi),%esi
	pa = PTE_ADDR(*pte);
80107490:	8b 37                	mov    (%edi),%esi
	if((mem = kalloc()) == 0)
80107492:	e8 69 b2 ff ff       	call   80102700 <kalloc>
80107497:	89 c2                	mov    %eax,%edx
80107499:	85 c0                	test   %eax,%eax
8010749b:	74 dd                	je     8010747a <CoW_handler+0x7a>
	pa = PTE_ADDR(*pte);
8010749d:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
	memmove(mem, (char*)P2V(pa), PGSIZE);
801074a3:	83 ec 04             	sub    $0x4,%esp
801074a6:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801074a9:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801074af:	68 00 10 00 00       	push   $0x1000
801074b4:	50                   	push   %eax
801074b5:	52                   	push   %edx
801074b6:	e8 85 d4 ff ff       	call   80104940 <memmove>
	*pte = V2P(mem) | PTE_P | PTE_U | PTE_W;
801074bb:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801074be:	81 c2 00 00 00 80    	add    $0x80000000,%edx
801074c4:	83 ca 07             	or     $0x7,%edx
801074c7:	89 17                	mov    %edx,(%edi)
	decr_refc(pa);
801074c9:	89 34 24             	mov    %esi,(%esp)
801074cc:	e8 2f b3 ff ff       	call   80102800 <decr_refc>
801074d1:	83 c4 10             	add    $0x10,%esp
801074d4:	eb 99                	jmp    8010746f <CoW_handler+0x6f>
	panic("CoW_handler: pte should exist");
801074d6:	83 ec 0c             	sub    $0xc,%esp
801074d9:	68 af 80 10 80       	push   $0x801080af
801074de:	e8 9d 8e ff ff       	call   80100380 <panic>
	panic("CoW_handler: No proc");
801074e3:	83 ec 0c             	sub    $0xc,%esp
801074e6:	68 9a 80 10 80       	push   $0x8010809a
801074eb:	e8 90 8e ff ff       	call   80100380 <panic>
	cprintf("Cur proc: %s %d\n", p->name, p->pid);
801074f0:	83 c3 6c             	add    $0x6c,%ebx
801074f3:	50                   	push   %eax
801074f4:	ff 73 a4             	push   -0x5c(%ebx)
801074f7:	53                   	push   %ebx
801074f8:	68 cd 80 10 80       	push   $0x801080cd
801074fd:	e8 9e 91 ff ff       	call   801006a0 <cprintf>
	panic("CoW_handler: page not present");
80107502:	c7 04 24 de 80 10 80 	movl   $0x801080de,(%esp)
80107509:	e8 72 8e ff ff       	call   80100380 <panic>
...
801075e6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *p = myproc();
801075e9:	e8 c2 c5 ff ff       	call   80103bb0 <myproc>
  if(p == 0)
801075ee:	85 c0                	test   %eax,%eax
801075f0:	74 76                	je     80107668 <scountptp+0x88>
  int count = 0;
  uint va = 0;
  pte_t *pte;
...
801075f2:	8b 30                	mov    (%eax),%esi
  ...
  for(uint pdx = 0; pdx < 1024; pdx++){
	pde = &p->pgdir[pdx];
801075f4:	8b 40 04             	mov    0x4(%eax),%eax
  for(; va < p->sz; va += PGSIZE){
801075f7:	85 f6                	test   %esi,%esi
801075f9:	74 69                	je     80107664 <scountptp+0x84>
  uint va = 0;
801075fb:	31 d2                	xor    %edx,%edx
  int count = 0;
801075fd:	31 c9                	xor    %ecx,%ecx
801075ff:	90                   	nop
  pde = &pgdir[PDX(va)];
80107600:	89 d3                	mov    %edx,%ebx
80107602:	c1 eb 16             	shr    $0x16,%ebx
  if(*pde & PTE_P){
80107605:	8b 1c 98             	mov    (%eax,%ebx,4),%ebx
80107608:	f6 c3 01             	test   $0x1,%bl
8010760b:	74 27                	je     80107634 <scountptp+0x54>
  return &pgtab[PTX(va)];
8010760d:	89 d7                	mov    %edx,%edi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010760f:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  return &pgtab[PTX(va)];
80107615:	c1 ef 0a             	shr    $0xa,%edi
80107618:	81 e7 fc 0f 00 00    	and    $0xffc,%edi
8010761e:	8d 9c 3b 00 00 00 80 	lea    -0x80000000(%ebx,%edi,1),%ebx
	if((pte = walkpgdir(p->pgdir, (void*)va, 0)) != 0 && (*pte & PTE_P))
80107625:	85 db                	test   %ebx,%ebx
80107627:	74 0b                	je     80107634 <scountptp+0x54>
80107629:	8b 1b                	mov    (%ebx),%ebx
8010762b:	83 e3 01             	and    $0x1,%ebx
	  count++;
8010762e:	83 fb 01             	cmp    $0x1,%ebx
80107631:	83 d9 ff             	sbb    $0xffffffff,%ecx
  for(; va < p->sz; va += PGSIZE){
80107634:	81 c2 00 10 00 00    	add    $0x1000,%edx
8010763a:	39 f2                	cmp    %esi,%edx
8010763c:	72 c2                	jb     80107600 <scountptp+0x20>
8010763e:	8d 98 00 10 00 00    	lea    0x1000(%eax),%ebx
80107644:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	if(*pde & PTE_P)
80107648:	8b 10                	mov    (%eax),%edx
8010764a:	83 e2 01             	and    $0x1,%edx
	  count++;
8010764d:	83 fa 01             	cmp    $0x1,%edx
80107650:	83 d9 ff             	sbb    $0xffffffff,%ecx
  for(uint pdx = 0; pdx < 1024; pdx++){
80107653:	83 c0 04             	add    $0x4,%eax
80107656:	39 c3                	cmp    %eax,%ebx
80107658:	75 ee                	jne    80107648 <scountptp+0x68>
  }

  return count;
}
8010765a:	83 c4 0c             	add    $0xc,%esp
8010765d:	89 c8                	mov    %ecx,%eax
8010765f:	5b                   	pop    %ebx
80107660:	5e                   	pop    %esi
80107661:	5f                   	pop    %edi
80107662:	5d                   	pop    %ebp
...
80107666:	eb d6                	jmp    8010763e <scountptp+0x5e>
	return -1;
80107668:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
8010766d:	eb eb                	jmp    8010765a <scountptp+0x7a>

8010766f <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
8010766f:	a1 00 00 00 00       	mov    0x0,%eax
80107674:	0f 0b                	ud2    

80107676 <copyout.cold>:
80107676:	a1 00 00 00 00       	mov    0x0,%eax
8010767b:	0f 0b                	ud2    
