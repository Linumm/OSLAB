...
80105877:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
8010587e:	08 00 00 8e 
80105882:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105889:	80 
8010588a:	c1 ea 10             	shr    $0x10,%edx
8010588d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105894:	80 
  for(i = 0; i < 256; i++)
...
801058a7:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
801058ae:	00 00 ef 
  initlock(&tickslock, "time");
801058b1:	68 19 79 10 80       	push   $0x80107919
801058b6:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801058bb:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
801058c1:	c1 e8 10             	shr    $0x10,%eax
801058c4:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
...
801058eb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801058ef:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105b25:	e8 76 ea ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105b2a:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105b31:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105b38:	e8 c3 e5 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105b3d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
...
{
  if(!uart)
80105ba0:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105c27:	74 78                	je     80105ca1 <uartinit+0xd1>
  uart = 1;
80105c29:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105c30:	00 00 00 
...
80105c59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105c60:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
801069d0:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106ecb:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
