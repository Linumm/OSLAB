...
8010253b:	e8 70 23 00 00       	call   801048b0 <memset>
  	r->next = kmem.freelist;
...
80102685:	e8 96 1f 00 00       	call   80104620 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102753:	e8 38 20 00 00       	call   80104790 <release>
  return (char*)r;
...
80102768:	e8 83 20 00 00       	call   801047f0 <acquire>
  r = kmem.freelist;
...
801027c8:	e8 23 20 00 00       	call   801047f0 <acquire>
  kmem.pgref[pa >> PTXSHIFT]++;
...
801027f0:	c9                   	leave  
	release(&kmem.lock);
801027f1:	e9 9a 1f 00 00       	jmp    80104790 <release>
...
80102838:	e8 b3 1f 00 00       	call   801047f0 <acquire>
  kmem.pgref[pa >> PTXSHIFT]--;
...
80102860:	c9                   	leave  
	release(&kmem.lock);
80102861:	e9 2a 1f 00 00       	jmp    80104790 <release>
...
801028a0:	e8 4b 1f 00 00       	call   801047f0 <acquire>
  if(kmem.use_lock)
...
801028c4:	e8 c7 1e 00 00       	call   80104790 <release>
  return ret;
...
801028fb:	e8 f0 1e 00 00       	call   801047f0 <acquire>
  if(kmem.use_lock)
...
8010291d:	e8 6e 1e 00 00       	call   80104790 <release>
...
80102d37:	e8 c4 1b 00 00       	call   80104900 <memcmp>
...
80102e64:	e8 e7 1a 00 00       	call   80104950 <memmove>
...
80102fab:	e8 40 18 00 00       	call   801047f0 <acquire>
...
80102fc5:	e8 c6 12 00 00       	call   80104290 <sleep>
...
8010301e:	e8 cd 17 00 00       	call   801047f0 <acquire>
  log.outstanding -= 1;
...
8010305c:	e8 2f 17 00 00       	call   80104790 <release>
}
...
80103076:	e8 75 17 00 00       	call   801047f0 <acquire>
    wakeup(&log);
...
80103089:	00 00 00 
    wakeup(&log);
8010308c:	e8 bf 12 00 00       	call   80104350 <wakeup>
    release(&log.lock);
80103091:	c7 04 24 a0 a6 14 80 	movl   $0x8014a6a0,(%esp)
80103098:	e8 f3 16 00 00       	call   80104790 <release>
...
801030f4:	e8 57 18 00 00       	call   80104950 <memmove>
...
80103148:	e8 03 12 00 00       	call   80104350 <wakeup>
  release(&log.lock);
8010314d:	c7 04 24 a0 a6 14 80 	movl   $0x8014a6a0,(%esp)
80103154:	e8 37 16 00 00       	call   80104790 <release>
...
801031b6:	e8 35 16 00 00       	call   801047f0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
801031f4:	c9                   	leave  
  release(&log.lock);
801031f5:	e9 96 15 00 00       	jmp    80104790 <release>
...
80103262:	e8 09 29 00 00       	call   80105b70 <idtinit>
...
801032e9:	e8 22 08 00 00       	call   80103b10 <pinit>
  tvinit();        // trap vectors
801032ee:	e8 fd 27 00 00       	call   80105af0 <tvinit>
  binit();         // buffer cache
...
80103314:	e8 37 16 00 00       	call   80104950 <memmove>
...
80103404:	e8 f7 14 00 00       	call   80104900 <memcmp>
...
801034bc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
801034bf:	e8 3c 14 00 00       	call   80104900 <memcmp>
...
80103608:	e8 f3 12 00 00       	call   80104900 <memcmp>
...
801036e9:	e8 32 0f 00 00       	call   80104620 <initlock>
  (*f0)->type = FD_PIPE;
...
8010377f:	e8 6c 10 00 00       	call   801047f0 <acquire>
  if(writable){
...
8010379f:	e8 ac 0b 00 00       	call   80104350 <wakeup>
...
801037c3:	5d                   	pop    %ebp
    release(&p->lock);
801037c4:	e9 c7 0f 00 00       	jmp    80104790 <release>
801037c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
801037d0:	83 ec 0c             	sub    $0xc,%esp
801037d3:	53                   	push   %ebx
801037d4:	e8 b7 0f 00 00       	call   80104790 <release>
    kfree((char*)p);
...
80103804:	e8 47 0b 00 00       	call   80104350 <wakeup>
...
8010381d:	e8 ce 0f 00 00       	call   801047f0 <acquire>
  for(i = 0; i < n; i++){
...
80103878:	e8 d3 0a 00 00       	call   80104350 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010387d:	58                   	pop    %eax
8010387e:	5a                   	pop    %edx
8010387f:	53                   	push   %ebx
80103880:	56                   	push   %esi
80103881:	e8 0a 0a 00 00       	call   80104290 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801038ac:	e8 df 0e 00 00       	call   80104790 <release>
        return -1;
...
801038fa:	e8 51 0a 00 00       	call   80104350 <wakeup>
  release(&p->lock);
801038ff:	89 1c 24             	mov    %ebx,(%esp)
80103902:	e8 89 0e 00 00       	call   80104790 <release>
  return n;
...
80103926:	e8 c5 0e 00 00       	call   801047f0 <acquire>
...
80103955:	e8 36 09 00 00       	call   80104290 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
801039b6:	e8 95 09 00 00       	call   80104350 <wakeup>
  release(&p->lock);
801039bb:	89 34 24             	mov    %esi,(%esp)
801039be:	e8 cd 0d 00 00       	call   80104790 <release>
  return i;
...
801039d9:	e8 b2 0d 00 00       	call   80104790 <release>
      return -1;
...
80103a01:	e8 ea 0d 00 00       	call   801047f0 <acquire>
...
80103a3c:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103a42:	e8 49 0d 00 00       	call   80104790 <release>
...
80103a64:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103a67:	c7 40 14 dd 5a 10 80 	movl   $0x80105add,0x14(%eax)
  p->context = (struct context*)sp;
...
80103a76:	e8 35 0e 00 00       	call   801048b0 <memset>
...
80103a9a:	e8 f1 0c 00 00       	call   80104790 <release>
}
...
80103acb:	e8 c0 0c 00 00       	call   80104790 <release>
...
80103b20:	e8 fb 0a 00 00       	call   80104620 <initlock>
}
...
80103b85:	68 70 7c 10 80       	push   $0x80107c70
...
80103bb4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103bb7:	e8 e4 0a 00 00       	call   801046a0 <pushcli>
  c = mycpu();
80103bbc:	e8 6f ff ff ff       	call   80103b30 <mycpu>
  p = c->proc;
80103bc1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bc7:	e8 24 0b 00 00       	call   801046f0 <popcli>
}
...
80103c26:	e8 85 0c 00 00       	call   801048b0 <memset>
...
80103c85:	e8 e6 0d 00 00       	call   80104a70 <safestrcpy>
  p->cwd = namei("/");
...
80103cd5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103cd8:	e8 c3 09 00 00       	call   801046a0 <pushcli>
  c = mycpu();
80103cdd:	e8 4e fe ff ff       	call   80103b30 <mycpu>
  p = c->proc;
80103ce2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ce8:	e8 03 0a 00 00       	call   801046f0 <popcli>
  sz = curproc->sz;
...
80103d56:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103d59:	e8 42 09 00 00       	call   801046a0 <pushcli>
  c = mycpu();
80103d5e:	e8 cd fd ff ff       	call   80103b30 <mycpu>
  p = c->proc;
80103d63:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d69:	e8 82 09 00 00       	call   801046f0 <popcli>
  if((np = allocproc()) == 0){
...
80103e9e:	e8 4d 09 00 00       	call   801047f0 <acquire>
...
80103ecb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103ed2:	e8 f4 0b 00 00       	call   80104acb <swtch>
      switchkvm();
...
80103efc:	e8 8f 08 00 00       	call   80104790 <release>
    sti();
...
80103f32:	e8 19 08 00 00       	call   80104750 <holding>
...
80103f73:	e8 53 0b 00 00       	call   80104acb <swtch>
  mycpu()->intena = intena;
...
8010403a:	e8 b1 07 00 00       	call   801047f0 <acquire>
...
80104160:	0f 84 af 00 00 00    	je     80104215 <wait+0x115>
80104166:	8b 46 24             	mov    0x24(%esi),%eax
80104169:	85 c0                	test   %eax,%eax
8010416b:	0f 85 a4 00 00 00    	jne    80104215 <wait+0x115>
  pushcli();
80104171:	e8 2a 05 00 00       	call   801046a0 <pushcli>
  c = mycpu();
80104176:	e8 b5 f9 ff ff       	call   80103b30 <mycpu>
  p = c->proc;
8010417b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104181:	e8 6a 05 00 00       	call   801046f0 <popcli>
  if(p == 0)
80104186:	85 db                	test   %ebx,%ebx
80104188:	0f 84 9e 00 00 00    	je     8010422c <wait+0x12c>
  p->chan = chan;
...
801041d3:	68 14 7c 10 80       	push   $0x80107c14
801041d8:	e8 c3 c4 ff ff       	call   801006a0 <cprintf>
        p->pid = 0;
801041dd:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
801041e4:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801041eb:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
801041ef:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
801041f6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801041fd:	c7 04 24 20 ad 14 80 	movl   $0x8014ad20,(%esp)
80104204:	e8 87 05 00 00       	call   80104790 <release>
        return pid;
80104209:	83 c4 10             	add    $0x10,%esp
}
8010420c:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010420f:	89 f0                	mov    %esi,%eax
80104211:	5b                   	pop    %ebx
80104212:	5e                   	pop    %esi
80104213:	5d                   	pop    %ebp
80104214:	c3                   	ret    
...
80104215:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104218:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010421d:	68 20 ad 14 80       	push   $0x8014ad20
80104222:	e8 69 05 00 00       	call   80104790 <release>
      return -1;
80104227:	83 c4 10             	add    $0x10,%esp
8010422a:	eb e0                	jmp    8010420c <wait+0x10c>
    panic("sleep");
8010422c:	83 ec 0c             	sub    $0xc,%esp
8010422f:	68 20 7c 10 80       	push   $0x80107c20
80104234:	e8 47 c1 ff ff       	call   80100380 <panic>
...
8010426d:	e8 9e fc ff ff       	call   80103f10 <sched>
  release(&ptable.lock);
80104272:	c7 04 24 20 ad 14 80 	movl   $0x8014ad20,(%esp)
...
8010429f:	e8 fc 03 00 00       	call   801046a0 <pushcli>
  c = mycpu();
801042a4:	e8 87 f8 ff ff       	call   80103b30 <mycpu>
  p = c->proc;
...
801042c0:	81 fe 20 ad 14 80    	cmp    $0x8014ad20,%esi
801042c6:	74 50                	je     80104318 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
801042c8:	83 ec 0c             	sub    $0xc,%esp
801042cb:	68 20 ad 14 80       	push   $0x8014ad20
...
801042ec:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801042f3:	c7 04 24 20 ad 14 80 	movl   $0x8014ad20,(%esp)
...
80104339:	68 26 7c 10 80       	push   $0x80107c26
8010433e:	e8 3d c0 ff ff       	call   80100380 <panic>
    panic("sleep");
80104343:	83 ec 0c             	sub    $0xc,%esp
80104346:	68 20 7c 10 80       	push   $0x80107c20
...
8010438f:	3d 54 cc 14 80       	cmp    $0x8014cc54,%eax
80104394:	75 e4                	jne    8010437a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104396:	c7 45 08 20 ad 14 80 	movl   $0x8014ad20,0x8(%ebp)
}
8010439d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801043a0:	c9                   	leave  
  release(&ptable.lock);
801043a1:	e9 ea 03 00 00       	jmp    80104790 <release>
...
801043f6:	68 20 ad 14 80       	push   $0x8014ad20
801043fb:	e8 90 03 00 00       	call   80104790 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104413:	68 20 ad 14 80       	push   $0x8014ad20
...
80104439:	bb c0 ad 14 80       	mov    $0x8014adc0,%ebx
...
8010446c:	74 ea                	je     80104458 <procdump+0x28>
      state = "???";
8010446e:	ba 37 7c 10 80       	mov    $0x80107c37,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104473:	83 f8 05             	cmp    $0x5,%eax
80104476:	77 11                	ja     80104489 <procdump+0x59>
80104478:	8b 14 85 98 7c 10 80 	mov    -0x7fef8368(,%eax,4),%edx
      state = "???";
8010447f:	b8 37 7c 10 80       	mov    $0x80107c37,%eax
...
8010448e:	68 3b 7c 10 80       	push   $0x80107c3b
80104493:	e8 08 c2 ff ff       	call   801006a0 <cprintf>
    if(p->state == SLEEPING){
...
801044b5:	e8 86 01 00 00       	call   80104640 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801044cd:	68 81 76 10 80       	push   $0x80107681
...
801044fa:	68 b0 7c 10 80       	push   $0x80107cb0
...
80104563:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104569:	e8 42 f6 ff ff       	call   80103bb0 <myproc>
...
8010460b:	e8 a0 f5 ff ff       	call   80103bb0 <myproc>
...
801046ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
801046d0:	e8 5b f4 ff ff       	call   80103b30 <mycpu>
...
8010471c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104720:	e8 0b f4 ff ff       	call   80103b30 <mycpu>
...
80104735:	68 bb 7c 10 80       	push   $0x80107cbb
8010473a:	e8 41 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010473f:	83 ec 0c             	sub    $0xc,%esp
80104742:	68 d2 7c 10 80       	push   $0x80107cd2
...
80104773:	e8 b8 f3 ff ff       	call   80103b30 <mycpu>
...
8010482c:	e8 ff f2 ff ff       	call   80103b30 <mycpu>
...
8010488b:	e8 a0 f2 ff ff       	call   80103b30 <mycpu>
...
801048a0:	68 e1 7c 10 80       	push   $0x80107ce1
...
80104ae7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104aea:	e8 c1 f0 ff ff       	call   80103bb0 <myproc>
...
80104b27:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104b2a:	e8 81 f0 ff ff       	call   80103bb0 <myproc>
...
80104b75:	e8 36 f0 ff ff       	call   80103bb0 <myproc>
...
80104b83:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b86:	e8 25 f0 ff ff       	call   80103bb0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104bc6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104bc9:	e8 e2 ef ff ff       	call   80103bb0 <myproc>
80104bce:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104bd0:	e8 db ef ff ff       	call   80103bb0 <myproc>
...
80104bde:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104be1:	e8 ca ef ff ff       	call   80103bb0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c34:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c35:	e8 76 ef ff ff       	call   80103bb0 <myproc>
...
80104c43:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104c46:	e8 65 ef ff ff       	call   80103bb0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c5b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104c5e:	e8 4d ef ff ff       	call   80103bb0 <myproc>
  if(addr >= curproc->sz)
...
80104cb4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104cb7:	e8 f4 ee ff ff       	call   80103bb0 <myproc>
...
80104ccc:	8b 14 85 20 7d 10 80 	mov    -0x7fef82e0(,%eax,4),%edx
...
80104cf8:	68 e9 7c 10 80       	push   $0x80107ce9
...
80104e54:	68 a4 7d 10 80       	push   $0x80107da4
...
80104e6c:	68 a3 7d 10 80       	push   $0x80107da3
...
80104e81:	68 97 7d 10 80       	push   $0x80107d97
...
80104e9f:	68 a6 7d 10 80       	push   $0x80107da6
80104ea4:	e8 d7 b4 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104ea9:	83 ec 0c             	sub    $0xc,%esp
80104eac:	68 88 7d 10 80       	push   $0x80107d88
...
80104eee:	74 20                	je     80104f10 <sys_dup+0x50>
  struct proc *curproc = myproc();
80104ef0:	e8 bb ec ff ff       	call   80103bb0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104f60:	e8 4b ec ff ff       	call   80103bb0 <myproc>
...
80104fe0:	e8 cb eb ff ff       	call   80103bb0 <myproc>
...
80105060:	e8 4b eb ff ff       	call   80103bb0 <myproc>
...
80105071:	74 25                	je     80105098 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105073:	e8 38 eb ff ff       	call   80103bb0 <myproc>
  fileclose(f);
...
801050c0:	e8 eb ea ff ff       	call   80103bb0 <myproc>
...
80105142:	0f 88 e2 00 00 00    	js     8010522a <sys_link+0x11a>
  begin_op();
80105148:	e8 53 de ff ff       	call   80102fa0 <begin_op>
  if((ip = namei(old)) == 0){
...
801051db:	e8 d0 c6 ff ff       	call   801018b0 <iput>
  end_op();
801051e0:	e8 2b de ff ff       	call   80103010 <end_op>
  return 0;
...
8010521d:	e8 ee c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105222:	e8 e9 dd ff ff       	call   80103010 <end_op>
  return -1;
...
80105279:	0f 88 7a 01 00 00    	js     801053f9 <sys_unlink+0x199>
  begin_op();
8010527f:	e8 1c dd ff ff       	call   80102fa0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
801052ad:	58                   	pop    %eax
801052ae:	5a                   	pop    %edx
801052af:	68 a4 7d 10 80       	push   $0x80107da4
...
801052c8:	68 a3 7d 10 80       	push   $0x80107da3
...
80105367:	e8 a4 c6 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010536c:	e8 9f dc ff ff       	call   80103010 <end_op>
  return 0;
...
801053c6:	e8 45 c6 ff ff       	call   80101a10 <iunlockput>
  end_op();
801053cb:	e8 40 dc ff ff       	call   80103010 <end_op>
  return -1;
...
801053fe:	e9 73 ff ff ff       	jmp    80105376 <sys_unlink+0x116>
    end_op();
80105403:	e8 08 dc ff ff       	call   80103010 <end_op>
    return -1;
...
80105472:	78 79                	js     801054ed <sys_open+0xad>
  ...
  begin_op();
80105474:	e8 27 db ff ff       	call   80102fa0 <begin_op>
...
801054b7:	74 23                	je     801054dc <sys_open+0x9c>
  struct proc *curproc = myproc();
801054b9:	e8 f2 e6 ff ff       	call   80103bb0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801054e0:	e8 2b c5 ff ff       	call   80101a10 <iunlockput>
    end_op();
801054e5:	e8 26 db ff ff       	call   80103010 <end_op>
    return -1;
...
80105513:	75 99                	jne    801054ae <sys_open+0x6e>
      end_op();
80105515:	e8 f6 da ff ff       	call   80103010 <end_op>
      return -1;
...
80105583:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105586:	e8 15 da ff ff       	call   80102fa0 <begin_op>
...
801055bf:	e8 4c c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
801055c4:	e8 47 da ff ff       	call   80103010 <end_op>
  return 0;
...
801055cf:	c3                   	ret    
    end_op();
801055d0:	e8 3b da ff ff       	call   80103010 <end_op>
    return -1;
...
8010564e:	e8 bd c3 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105653:	e8 b8 d9 ff ff       	call   80103010 <end_op>
  return 0;
...
8010565f:	90                   	nop
    end_op();
80105660:	e8 ab d9 ff ff       	call   80103010 <end_op>
    return -1;
...
80105675:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105678:	e8 33 e5 ff ff       	call   80103bb0 <myproc>
8010567d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010567f:	e8 1c d9 ff ff       	call   80102fa0 <begin_op>
...
801056cd:	e8 de c1 ff ff       	call   801018b0 <iput>
  end_op();
801056d2:	e8 39 d9 ff ff       	call   80103010 <end_op>
  curproc->cwd = ip;
...
801056f4:	e8 17 c3 ff ff       	call   80101a10 <iunlockput>
    end_op();
801056f9:	e8 12 d9 ff ff       	call   80103010 <end_op>
    return -1;
...
8010570f:	90                   	nop
    end_op();
80105710:	e8 fb d8 ff ff       	call   80103010 <end_op>
    return -1;
...
80105838:	e8 33 de ff ff       	call   80103670 <pipealloc>
...
80105847:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105849:	e8 62 e3 ff ff       	call   80103bb0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105887:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010588a:	e8 21 e3 ff ff       	call   80103bb0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801058a6:	75 f0                	jne    80105898 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801058a8:	e8 03 e3 ff ff       	call   80103bb0 <myproc>
...
{
  return fork();
801058e0:	e9 6b e4 ff ff       	jmp    80103d50 <fork>
...
801058f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801058f6:	e8 d5 e6 ff ff       	call   80103fd0 <exit>
...
{
  return wait();
80105900:	e9 fb e7 ff ff       	jmp    80104100 <wait>
...
8010592e:	e8 7d ea ff ff       	call   801043b0 <kill>
...
80105953:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105956:	e8 55 e2 ff ff       	call   80103bb0 <myproc>
...
80105977:	78 27                	js     801059a0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105979:	e8 32 e2 ff ff       	call   80103bb0 <myproc>
  if(growproc(n) < 0)
...
80105986:	e8 45 e3 ff ff       	call   80103cd0 <growproc>
...
801059d0:	68 80 cc 14 80       	push   $0x8014cc80
801059d5:	e8 16 ee ff ff       	call   801047f0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801059da:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801059dd:	8b 1d 60 cc 14 80    	mov    0x8014cc60,%ebx
  while(ticks - ticks0 < n){
...
801059f3:	68 80 cc 14 80       	push   $0x8014cc80
801059f8:	68 60 cc 14 80       	push   $0x8014cc60
801059fd:	e8 8e e8 ff ff       	call   80104290 <sleep>
  while(ticks - ticks0 < n){
80105a02:	a1 60 cc 14 80       	mov    0x8014cc60,%eax
...
80105a0f:	73 2f                	jae    80105a40 <sys_sleep+0x90>
    if(myproc()->killed){
80105a11:	e8 9a e1 ff ff       	call   80103bb0 <myproc>
...
80105a20:	68 80 cc 14 80       	push   $0x8014cc80
...
80105a43:	68 80 cc 14 80       	push   $0x8014cc80
...
80105a64:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105a67:	68 80 cc 14 80       	push   $0x8014cc80
80105a6c:	e8 7f ed ff ff       	call   801047f0 <acquire>
  xticks = ticks;
80105a71:	8b 1d 60 cc 14 80    	mov    0x8014cc60,%ebx
  release(&tickslock);
80105a77:	c7 04 24 80 cc 14 80 	movl   $0x8014cc80,(%esp)
...
{
  return scountptp();
80105ac0:	e9 1b 1b 00 00       	jmp    801075e0 <scountptp>
...
80105b07:	c7 04 c5 c2 cc 14 80 	movl   $0x8e000008,-0x7feb333e(,%eax,8)
80105b0e:	08 00 00 8e 
80105b12:	66 89 14 c5 c0 cc 14 	mov    %dx,-0x7feb3340(,%eax,8)
80105b19:	80 
80105b1a:	c1 ea 10             	shr    $0x10,%edx
80105b1d:	66 89 14 c5 c6 cc 14 	mov    %dx,-0x7feb333a(,%eax,8)
80105b24:	80 
  for(i = 0; i < 256; i++)
...
80105b37:	c7 05 c2 ce 14 80 08 	movl   $0xef000008,0x8014cec2
80105b3e:	00 00 ef 
  initlock(&tickslock, "time");
80105b41:	68 e9 7d 10 80       	push   $0x80107de9
80105b46:	68 80 cc 14 80       	push   $0x8014cc80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b4b:	66 a3 c0 ce 14 80    	mov    %ax,0x8014cec0
80105b51:	c1 e8 10             	shr    $0x10,%eax
80105b54:	66 a3 c6 ce 14 80    	mov    %ax,0x8014cec6
  initlock(&tickslock, "time");
80105b5a:	e8 c1 ea ff ff       	call   80104620 <initlock>
}
...
80105b7b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b7f:	b8 c0 cc 14 80       	mov    $0x8014ccc0,%eax
...
80105bb2:	0f 84 30 01 00 00    	je     80105ce8 <trap+0x148>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105bc4:	ff 24 85 90 7e 10 80 	jmp    *-0x7fef8170(,%eax,4)
80105bcb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105bcf:	90                   	nop
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105bd0:	e8 bb df ff ff       	call   80103b90 <cpuid>
...
80105bd7:	0f 84 13 02 00 00    	je     80105df0 <trap+0x250>
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105bdd:	e8 6e cf ff ff       	call   80102b50 <lapiceoi>
  }
...
80105be2:	e8 c9 df ff ff       	call   80103bb0 <myproc>
80105be7:	85 c0                	test   %eax,%eax
80105be9:	74 1d                	je     80105c08 <trap+0x68>
80105beb:	e8 c0 df ff ff       	call   80103bb0 <myproc>
...
80105c08:	e8 a3 df ff ff       	call   80103bb0 <myproc>
80105c0d:	85 c0                	test   %eax,%eax
80105c0f:	74 0f                	je     80105c20 <trap+0x80>
80105c11:	e8 9a df ff ff       	call   80103bb0 <myproc>
80105c16:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105c1a:	0f 84 b0 00 00 00    	je     80105cd0 <trap+0x130>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c20:	e8 8b df ff ff       	call   80103bb0 <myproc>
80105c25:	85 c0                	test   %eax,%eax
80105c27:	74 1d                	je     80105c46 <trap+0xa6>
80105c29:	e8 82 df ff ff       	call   80103bb0 <myproc>
...
80105c40:	0f 84 cf 00 00 00    	je     80105d15 <trap+0x175>
    exit();
}
...
80105c50:	e8 5b df ff ff       	call   80103bb0 <myproc>
80105c55:	8b 7b 38             	mov    0x38(%ebx),%edi
80105c58:	85 c0                	test   %eax,%eax
80105c5a:	0f 84 c4 01 00 00    	je     80105e24 <trap+0x284>
80105c60:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105c64:	0f 84 ba 01 00 00    	je     80105e24 <trap+0x284>
...
80105c70:	e8 1b df ff ff       	call   80103b90 <cpuid>
...
80105c81:	e8 2a df ff ff       	call   80103bb0 <myproc>
80105c86:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105c89:	e8 22 df ff ff       	call   80103bb0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105ca5:	68 4c 7e 10 80       	push   $0x80107e4c
80105caa:	e8 f1 a9 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105caf:	83 c4 20             	add    $0x20,%esp
80105cb2:	e8 f9 de ff ff       	call   80103bb0 <myproc>
80105cb7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cbe:	e8 ed de ff ff       	call   80103bb0 <myproc>
80105cc3:	85 c0                	test   %eax,%eax
80105cc5:	0f 85 20 ff ff ff    	jne    80105beb <trap+0x4b>
80105ccb:	e9 38 ff ff ff       	jmp    80105c08 <trap+0x68>
  if(myproc() && myproc()->state == RUNNING &&
80105cd0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105cd4:	0f 85 46 ff ff ff    	jne    80105c20 <trap+0x80>
    yield();
80105cda:	e8 61 e5 ff ff       	call   80104240 <yield>
80105cdf:	e9 3c ff ff ff       	jmp    80105c20 <trap+0x80>
80105ce4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105ce8:	e8 c3 de ff ff       	call   80103bb0 <myproc>
80105ced:	8b 70 24             	mov    0x24(%eax),%esi
80105cf0:	85 f6                	test   %esi,%esi
80105cf2:	0f 85 e8 00 00 00    	jne    80105de0 <trap+0x240>
    myproc()->tf = tf;
80105cf8:	e8 b3 de ff ff       	call   80103bb0 <myproc>
80105cfd:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105d00:	e8 ab ef ff ff       	call   80104cb0 <syscall>
    if(myproc()->killed)
80105d05:	e8 a6 de ff ff       	call   80103bb0 <myproc>
80105d0a:	8b 48 24             	mov    0x24(%eax),%ecx
80105d0d:	85 c9                	test   %ecx,%ecx
80105d0f:	0f 84 31 ff ff ff    	je     80105c46 <trap+0xa6>
}
80105d15:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105d18:	5b                   	pop    %ebx
80105d19:	5e                   	pop    %esi
80105d1a:	5f                   	pop    %edi
80105d1b:	5d                   	pop    %ebp
      exit();
80105d1c:	e9 af e2 ff ff       	jmp    80103fd0 <exit>
...
80105d2f:	e8 5c de ff ff       	call   80103b90 <cpuid>
80105d34:	57                   	push   %edi
80105d35:	56                   	push   %esi
80105d36:	50                   	push   %eax
80105d37:	68 f4 7d 10 80       	push   $0x80107df4
80105d3c:	e8 5f a9 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105d41:	e8 0a ce ff ff       	call   80102b50 <lapiceoi>
    break;
80105d46:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d49:	e8 62 de ff ff       	call   80103bb0 <myproc>
80105d4e:	85 c0                	test   %eax,%eax
80105d50:	0f 85 95 fe ff ff    	jne    80105beb <trap+0x4b>
80105d56:	e9 ad fe ff ff       	jmp    80105c08 <trap+0x68>
80105d5b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105d5f:	90                   	nop
    kbdintr();
80105d60:	e8 ab cc ff ff       	call   80102a10 <kbdintr>
    lapiceoi();
80105d65:	e8 e6 cd ff ff       	call   80102b50 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d6a:	e8 41 de ff ff       	call   80103bb0 <myproc>
80105d6f:	85 c0                	test   %eax,%eax
80105d71:	0f 85 74 fe ff ff    	jne    80105beb <trap+0x4b>
80105d77:	e9 8c fe ff ff       	jmp    80105c08 <trap+0x68>
80105d7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105d80:	e8 3b 02 00 00       	call   80105fc0 <uartintr>
    lapiceoi();
80105d85:	e8 c6 cd ff ff       	call   80102b50 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d8a:	e8 21 de ff ff       	call   80103bb0 <myproc>
...
80105da5:	e9 33 fe ff ff       	jmp    80105bdd <trap+0x3d>
80105daa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	CoW_handler();
80105db0:	e8 5b 16 00 00       	call   80107410 <CoW_handler>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105db5:	e8 f6 dd ff ff       	call   80103bb0 <myproc>
80105dba:	85 c0                	test   %eax,%eax
80105dbc:	0f 85 29 fe ff ff    	jne    80105beb <trap+0x4b>
80105dc2:	e9 41 fe ff ff       	jmp    80105c08 <trap+0x68>
...
80105de5:	e9 0e ff ff ff       	jmp    80105cf8 <trap+0x158>
80105dea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105df0:	83 ec 0c             	sub    $0xc,%esp
80105df3:	68 80 cc 14 80       	push   $0x8014cc80
80105df8:	e8 f3 e9 ff ff       	call   801047f0 <acquire>
      wakeup(&ticks);
80105dfd:	c7 04 24 60 cc 14 80 	movl   $0x8014cc60,(%esp)
      ticks++;
80105e04:	83 05 60 cc 14 80 01 	addl   $0x1,0x8014cc60
      wakeup(&ticks);
80105e0b:	e8 40 e5 ff ff       	call   80104350 <wakeup>
      release(&tickslock);
80105e10:	c7 04 24 80 cc 14 80 	movl   $0x8014cc80,(%esp)
80105e17:	e8 74 e9 ff ff       	call   80104790 <release>
...
80105e35:	68 18 7e 10 80       	push   $0x80107e18
80105e3a:	e8 61 a8 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105e3f:	83 c4 14             	add    $0x14,%esp
80105e42:	68 ee 7d 10 80       	push   $0x80107dee
...
{
  if(!uart)
80105e50:	a1 c0 d4 14 80       	mov    0x8014d4c0,%eax
...
80105ed7:	74 78                	je     80105f51 <uartinit+0xd1>
  uart = 1;
80105ed9:	c7 05 c0 d4 14 80 01 	movl   $0x1,0x8014d4c0
80105ee0:	00 00 00 
...
80105eec:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105eef:	bf 58 7f 10 80       	mov    $0x80107f58,%edi
...
80105f60 <uartputc>:
  if(!uart)
80105f60:	a1 c0 d4 14 80       	mov    0x8014d4c0,%eax
...
80105fd7:	6a 00                	push   $0x0
  jmp alltraps
80105fd9:	e9 e7 fa ff ff       	jmp    80105ac5 <alltraps>
...
80105fe0:	6a 01                	push   $0x1
  jmp alltraps
80105fe2:	e9 de fa ff ff       	jmp    80105ac5 <alltraps>
...
80105fe9:	6a 02                	push   $0x2
  jmp alltraps
80105feb:	e9 d5 fa ff ff       	jmp    80105ac5 <alltraps>
...
80105ff2:	6a 03                	push   $0x3
  jmp alltraps
80105ff4:	e9 cc fa ff ff       	jmp    80105ac5 <alltraps>
...
80105ffb:	6a 04                	push   $0x4
  jmp alltraps
80105ffd:	e9 c3 fa ff ff       	jmp    80105ac5 <alltraps>
...
80106004:	6a 05                	push   $0x5
  jmp alltraps
80106006:	e9 ba fa ff ff       	jmp    80105ac5 <alltraps>
...
80106016:	6a 07                	push   $0x7
  jmp alltraps
80106018:	e9 a8 fa ff ff       	jmp    80105ac5 <alltraps>
...
8010601d:	6a 08                	push   $0x8
  jmp alltraps
8010601f:	e9 a1 fa ff ff       	jmp    80105ac5 <alltraps>
...
80106026:	6a 09                	push   $0x9
  jmp alltraps
80106028:	e9 98 fa ff ff       	jmp    80105ac5 <alltraps>
...
8010602d:	6a 0a                	push   $0xa
  jmp alltraps
8010602f:	e9 91 fa ff ff       	jmp    80105ac5 <alltraps>
...
80106034:	6a 0b                	push   $0xb
  jmp alltraps
80106036:	e9 8a fa ff ff       	jmp    80105ac5 <alltraps>
...
80106049:	6a 0e                	push   $0xe
  jmp alltraps
8010604b:	e9 75 fa ff ff       	jmp    80105ac5 <alltraps>
...
80106052:	6a 0f                	push   $0xf
  jmp alltraps
80106054:	e9 6c fa ff ff       	jmp    80105ac5 <alltraps>
...
8010605b:	6a 10                	push   $0x10
  jmp alltraps
8010605d:	e9 63 fa ff ff       	jmp    80105ac5 <alltraps>
...
80106062:	6a 11                	push   $0x11
  jmp alltraps
80106064:	e9 5c fa ff ff       	jmp    80105ac5 <alltraps>
...
8010606b:	6a 12                	push   $0x12
  jmp alltraps
8010606d:	e9 53 fa ff ff       	jmp    80105ac5 <alltraps>
...
80106074:	6a 13                	push   $0x13
  jmp alltraps
80106076:	e9 4a fa ff ff       	jmp    80105ac5 <alltraps>
...
8010607d:	6a 14                	push   $0x14
  jmp alltraps
8010607f:	e9 41 fa ff ff       	jmp    80105ac5 <alltraps>
...
80106086:	6a 15                	push   $0x15
  jmp alltraps
80106088:	e9 38 fa ff ff       	jmp    80105ac5 <alltraps>
...
8010608f:	6a 16                	push   $0x16
  jmp alltraps
80106091:	e9 2f fa ff ff       	jmp    80105ac5 <alltraps>
...
80106098:	6a 17                	push   $0x17
  jmp alltraps
8010609a:	e9 26 fa ff ff       	jmp    80105ac5 <alltraps>
...
801060a1:	6a 18                	push   $0x18
  jmp alltraps
801060a3:	e9 1d fa ff ff       	jmp    80105ac5 <alltraps>
...
801060aa:	6a 19                	push   $0x19
  jmp alltraps
801060ac:	e9 14 fa ff ff       	jmp    80105ac5 <alltraps>
...
801060b3:	6a 1a                	push   $0x1a
  jmp alltraps
801060b5:	e9 0b fa ff ff       	jmp    80105ac5 <alltraps>
...
801060bc:	6a 1b                	push   $0x1b
  jmp alltraps
801060be:	e9 02 fa ff ff       	jmp    80105ac5 <alltraps>
...
801060c5:	6a 1c                	push   $0x1c
  jmp alltraps
801060c7:	e9 f9 f9 ff ff       	jmp    80105ac5 <alltraps>
...
801060ce:	6a 1d                	push   $0x1d
  jmp alltraps
801060d0:	e9 f0 f9 ff ff       	jmp    80105ac5 <alltraps>
...
801060d7:	6a 1e                	push   $0x1e
  jmp alltraps
801060d9:	e9 e7 f9 ff ff       	jmp    80105ac5 <alltraps>
...
801060e0:	6a 1f                	push   $0x1f
  jmp alltraps
801060e2:	e9 de f9 ff ff       	jmp    80105ac5 <alltraps>
...
801060e9:	6a 20                	push   $0x20
  jmp alltraps
801060eb:	e9 d5 f9 ff ff       	jmp    80105ac5 <alltraps>
...
801060f2:	6a 21                	push   $0x21
  jmp alltraps
801060f4:	e9 cc f9 ff ff       	jmp    80105ac5 <alltraps>
...
801060fb:	6a 22                	push   $0x22
  jmp alltraps
801060fd:	e9 c3 f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106104:	6a 23                	push   $0x23
  jmp alltraps
80106106:	e9 ba f9 ff ff       	jmp    80105ac5 <alltraps>
...
8010610d:	6a 24                	push   $0x24
  jmp alltraps
8010610f:	e9 b1 f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106116:	6a 25                	push   $0x25
  jmp alltraps
80106118:	e9 a8 f9 ff ff       	jmp    80105ac5 <alltraps>
...
8010611f:	6a 26                	push   $0x26
  jmp alltraps
80106121:	e9 9f f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106128:	6a 27                	push   $0x27
  jmp alltraps
8010612a:	e9 96 f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106131:	6a 28                	push   $0x28
  jmp alltraps
80106133:	e9 8d f9 ff ff       	jmp    80105ac5 <alltraps>
...
8010613a:	6a 29                	push   $0x29
  jmp alltraps
8010613c:	e9 84 f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106143:	6a 2a                	push   $0x2a
  jmp alltraps
80106145:	e9 7b f9 ff ff       	jmp    80105ac5 <alltraps>
...
8010614c:	6a 2b                	push   $0x2b
  jmp alltraps
8010614e:	e9 72 f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106155:	6a 2c                	push   $0x2c
  jmp alltraps
80106157:	e9 69 f9 ff ff       	jmp    80105ac5 <alltraps>
...
8010615e:	6a 2d                	push   $0x2d
  jmp alltraps
80106160:	e9 60 f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106167:	6a 2e                	push   $0x2e
  jmp alltraps
80106169:	e9 57 f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106170:	6a 2f                	push   $0x2f
  jmp alltraps
80106172:	e9 4e f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106179:	6a 30                	push   $0x30
  jmp alltraps
8010617b:	e9 45 f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106182:	6a 31                	push   $0x31
  jmp alltraps
80106184:	e9 3c f9 ff ff       	jmp    80105ac5 <alltraps>
...
8010618b:	6a 32                	push   $0x32
  jmp alltraps
8010618d:	e9 33 f9 ff ff       	jmp    80105ac5 <alltraps>
...
80106194:	6a 33                	push   $0x33
  jmp alltraps
80106196:	e9 2a f9 ff ff       	jmp    80105ac5 <alltraps>
...
8010619d:	6a 34                	push   $0x34
  jmp alltraps
8010619f:	e9 21 f9 ff ff       	jmp    80105ac5 <alltraps>
...
801061a6:	6a 35                	push   $0x35
  jmp alltraps
801061a8:	e9 18 f9 ff ff       	jmp    80105ac5 <alltraps>
...
801061af:	6a 36                	push   $0x36
  jmp alltraps
801061b1:	e9 0f f9 ff ff       	jmp    80105ac5 <alltraps>
...
801061b8:	6a 37                	push   $0x37
  jmp alltraps
801061ba:	e9 06 f9 ff ff       	jmp    80105ac5 <alltraps>
...
801061c1:	6a 38                	push   $0x38
  jmp alltraps
801061c3:	e9 fd f8 ff ff       	jmp    80105ac5 <alltraps>
...
801061ca:	6a 39                	push   $0x39
  jmp alltraps
801061cc:	e9 f4 f8 ff ff       	jmp    80105ac5 <alltraps>
...
801061d3:	6a 3a                	push   $0x3a
  jmp alltraps
801061d5:	e9 eb f8 ff ff       	jmp    80105ac5 <alltraps>
...
801061dc:	6a 3b                	push   $0x3b
  jmp alltraps
801061de:	e9 e2 f8 ff ff       	jmp    80105ac5 <alltraps>
...
801061e5:	6a 3c                	push   $0x3c
  jmp alltraps
801061e7:	e9 d9 f8 ff ff       	jmp    80105ac5 <alltraps>
...
801061ee:	6a 3d                	push   $0x3d
  jmp alltraps
801061f0:	e9 d0 f8 ff ff       	jmp    80105ac5 <alltraps>
...
801061f7:	6a 3e                	push   $0x3e
  jmp alltraps
801061f9:	e9 c7 f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106200:	6a 3f                	push   $0x3f
  jmp alltraps
80106202:	e9 be f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106209:	6a 40                	push   $0x40
  jmp alltraps
8010620b:	e9 b5 f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106212:	6a 41                	push   $0x41
  jmp alltraps
80106214:	e9 ac f8 ff ff       	jmp    80105ac5 <alltraps>
...
8010621b:	6a 42                	push   $0x42
  jmp alltraps
8010621d:	e9 a3 f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106224:	6a 43                	push   $0x43
  jmp alltraps
80106226:	e9 9a f8 ff ff       	jmp    80105ac5 <alltraps>
...
8010622d:	6a 44                	push   $0x44
  jmp alltraps
8010622f:	e9 91 f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106236:	6a 45                	push   $0x45
  jmp alltraps
80106238:	e9 88 f8 ff ff       	jmp    80105ac5 <alltraps>
...
8010623f:	6a 46                	push   $0x46
  jmp alltraps
80106241:	e9 7f f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106248:	6a 47                	push   $0x47
  jmp alltraps
8010624a:	e9 76 f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106251:	6a 48                	push   $0x48
  jmp alltraps
80106253:	e9 6d f8 ff ff       	jmp    80105ac5 <alltraps>
...
8010625a:	6a 49                	push   $0x49
  jmp alltraps
8010625c:	e9 64 f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106263:	6a 4a                	push   $0x4a
  jmp alltraps
80106265:	e9 5b f8 ff ff       	jmp    80105ac5 <alltraps>
...
8010626c:	6a 4b                	push   $0x4b
  jmp alltraps
8010626e:	e9 52 f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106275:	6a 4c                	push   $0x4c
  jmp alltraps
80106277:	e9 49 f8 ff ff       	jmp    80105ac5 <alltraps>
...
8010627e:	6a 4d                	push   $0x4d
  jmp alltraps
80106280:	e9 40 f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106287:	6a 4e                	push   $0x4e
  jmp alltraps
80106289:	e9 37 f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106290:	6a 4f                	push   $0x4f
  jmp alltraps
80106292:	e9 2e f8 ff ff       	jmp    80105ac5 <alltraps>
...
80106299:	6a 50                	push   $0x50
  jmp alltraps
8010629b:	e9 25 f8 ff ff       	jmp    80105ac5 <alltraps>
...
801062a2:	6a 51                	push   $0x51
  jmp alltraps
801062a4:	e9 1c f8 ff ff       	jmp    80105ac5 <alltraps>
...
801062ab:	6a 52                	push   $0x52
  jmp alltraps
801062ad:	e9 13 f8 ff ff       	jmp    80105ac5 <alltraps>
...
801062b4:	6a 53                	push   $0x53
  jmp alltraps
801062b6:	e9 0a f8 ff ff       	jmp    80105ac5 <alltraps>
...
801062bd:	6a 54                	push   $0x54
  jmp alltraps
801062bf:	e9 01 f8 ff ff       	jmp    80105ac5 <alltraps>
...
801062c6:	6a 55                	push   $0x55
  jmp alltraps
801062c8:	e9 f8 f7 ff ff       	jmp    80105ac5 <alltraps>
...
801062cf:	6a 56                	push   $0x56
  jmp alltraps
801062d1:	e9 ef f7 ff ff       	jmp    80105ac5 <alltraps>
...
801062d8:	6a 57                	push   $0x57
  jmp alltraps
801062da:	e9 e6 f7 ff ff       	jmp    80105ac5 <alltraps>
...
801062e1:	6a 58                	push   $0x58
  jmp alltraps
801062e3:	e9 dd f7 ff ff       	jmp    80105ac5 <alltraps>
...
801062ea:	6a 59                	push   $0x59
  jmp alltraps
801062ec:	e9 d4 f7 ff ff       	jmp    80105ac5 <alltraps>
...
801062f3:	6a 5a                	push   $0x5a
  jmp alltraps
801062f5:	e9 cb f7 ff ff       	jmp    80105ac5 <alltraps>
...
801062fc:	6a 5b                	push   $0x5b
  jmp alltraps
801062fe:	e9 c2 f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106305:	6a 5c                	push   $0x5c
  jmp alltraps
80106307:	e9 b9 f7 ff ff       	jmp    80105ac5 <alltraps>
...
8010630e:	6a 5d                	push   $0x5d
  jmp alltraps
80106310:	e9 b0 f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106317:	6a 5e                	push   $0x5e
  jmp alltraps
80106319:	e9 a7 f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106320:	6a 5f                	push   $0x5f
  jmp alltraps
80106322:	e9 9e f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106329:	6a 60                	push   $0x60
  jmp alltraps
8010632b:	e9 95 f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106332:	6a 61                	push   $0x61
  jmp alltraps
80106334:	e9 8c f7 ff ff       	jmp    80105ac5 <alltraps>
...
8010633b:	6a 62                	push   $0x62
  jmp alltraps
8010633d:	e9 83 f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106344:	6a 63                	push   $0x63
  jmp alltraps
80106346:	e9 7a f7 ff ff       	jmp    80105ac5 <alltraps>
...
8010634d:	6a 64                	push   $0x64
  jmp alltraps
8010634f:	e9 71 f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106356:	6a 65                	push   $0x65
  jmp alltraps
80106358:	e9 68 f7 ff ff       	jmp    80105ac5 <alltraps>
...
8010635f:	6a 66                	push   $0x66
  jmp alltraps
80106361:	e9 5f f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106368:	6a 67                	push   $0x67
  jmp alltraps
8010636a:	e9 56 f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106371:	6a 68                	push   $0x68
  jmp alltraps
80106373:	e9 4d f7 ff ff       	jmp    80105ac5 <alltraps>
...
8010637a:	6a 69                	push   $0x69
  jmp alltraps
8010637c:	e9 44 f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106383:	6a 6a                	push   $0x6a
  jmp alltraps
80106385:	e9 3b f7 ff ff       	jmp    80105ac5 <alltraps>
...
8010638c:	6a 6b                	push   $0x6b
  jmp alltraps
8010638e:	e9 32 f7 ff ff       	jmp    80105ac5 <alltraps>
...
80106395:	6a 6c                	push   $0x6c
  jmp alltraps
80106397:	e9 29 f7 ff ff       	jmp    80105ac5 <alltraps>
...
8010639e:	6a 6d                	push   $0x6d
  jmp alltraps
801063a0:	e9 20 f7 ff ff       	jmp    80105ac5 <alltraps>
...
801063a7:	6a 6e                	push   $0x6e
  jmp alltraps
801063a9:	e9 17 f7 ff ff       	jmp    80105ac5 <alltraps>
...
801063b0:	6a 6f                	push   $0x6f
  jmp alltraps
801063b2:	e9 0e f7 ff ff       	jmp    80105ac5 <alltraps>
...
801063b9:	6a 70                	push   $0x70
  jmp alltraps
801063bb:	e9 05 f7 ff ff       	jmp    80105ac5 <alltraps>
...
801063c2:	6a 71                	push   $0x71
  jmp alltraps
801063c4:	e9 fc f6 ff ff       	jmp    80105ac5 <alltraps>
...
801063cb:	6a 72                	push   $0x72
  jmp alltraps
801063cd:	e9 f3 f6 ff ff       	jmp    80105ac5 <alltraps>
...
801063d4:	6a 73                	push   $0x73
  jmp alltraps
801063d6:	e9 ea f6 ff ff       	jmp    80105ac5 <alltraps>
...
801063dd:	6a 74                	push   $0x74
  jmp alltraps
801063df:	e9 e1 f6 ff ff       	jmp    80105ac5 <alltraps>
...
801063e6:	6a 75                	push   $0x75
  jmp alltraps
801063e8:	e9 d8 f6 ff ff       	jmp    80105ac5 <alltraps>
...
801063ef:	6a 76                	push   $0x76
  jmp alltraps
801063f1:	e9 cf f6 ff ff       	jmp    80105ac5 <alltraps>
...
801063f8:	6a 77                	push   $0x77
  jmp alltraps
801063fa:	e9 c6 f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106401:	6a 78                	push   $0x78
  jmp alltraps
80106403:	e9 bd f6 ff ff       	jmp    80105ac5 <alltraps>
...
8010640a:	6a 79                	push   $0x79
  jmp alltraps
8010640c:	e9 b4 f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106413:	6a 7a                	push   $0x7a
  jmp alltraps
80106415:	e9 ab f6 ff ff       	jmp    80105ac5 <alltraps>
...
8010641c:	6a 7b                	push   $0x7b
  jmp alltraps
8010641e:	e9 a2 f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106425:	6a 7c                	push   $0x7c
  jmp alltraps
80106427:	e9 99 f6 ff ff       	jmp    80105ac5 <alltraps>
...
8010642e:	6a 7d                	push   $0x7d
  jmp alltraps
80106430:	e9 90 f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106437:	6a 7e                	push   $0x7e
  jmp alltraps
80106439:	e9 87 f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106440:	6a 7f                	push   $0x7f
  jmp alltraps
80106442:	e9 7e f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106449:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010644e:	e9 72 f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106455:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010645a:	e9 66 f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106461:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106466:	e9 5a f6 ff ff       	jmp    80105ac5 <alltraps>
...
8010646d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106472:	e9 4e f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106479:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010647e:	e9 42 f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106485:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010648a:	e9 36 f6 ff ff       	jmp    80105ac5 <alltraps>
...
80106491:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106496:	e9 2a f6 ff ff       	jmp    80105ac5 <alltraps>
...
8010649d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801064a2:	e9 1e f6 ff ff       	jmp    80105ac5 <alltraps>
...
801064a9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801064ae:	e9 12 f6 ff ff       	jmp    80105ac5 <alltraps>
...
801064b5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801064ba:	e9 06 f6 ff ff       	jmp    80105ac5 <alltraps>
...
801064c1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801064c6:	e9 fa f5 ff ff       	jmp    80105ac5 <alltraps>
...
801064cd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801064d2:	e9 ee f5 ff ff       	jmp    80105ac5 <alltraps>
...
801064d9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801064de:	e9 e2 f5 ff ff       	jmp    80105ac5 <alltraps>
...
801064e5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801064ea:	e9 d6 f5 ff ff       	jmp    80105ac5 <alltraps>
...
801064f1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801064f6:	e9 ca f5 ff ff       	jmp    80105ac5 <alltraps>
...
801064fd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106502:	e9 be f5 ff ff       	jmp    80105ac5 <alltraps>
...
80106509:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010650e:	e9 b2 f5 ff ff       	jmp    80105ac5 <alltraps>
...
80106515:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010651a:	e9 a6 f5 ff ff       	jmp    80105ac5 <alltraps>
...
80106521:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106526:	e9 9a f5 ff ff       	jmp    80105ac5 <alltraps>
...
8010652d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106532:	e9 8e f5 ff ff       	jmp    80105ac5 <alltraps>
...
80106539:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010653e:	e9 82 f5 ff ff       	jmp    80105ac5 <alltraps>
...
80106545:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010654a:	e9 76 f5 ff ff       	jmp    80105ac5 <alltraps>
...
80106551:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106556:	e9 6a f5 ff ff       	jmp    80105ac5 <alltraps>
...
8010655d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106562:	e9 5e f5 ff ff       	jmp    80105ac5 <alltraps>
...
80106569:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010656e:	e9 52 f5 ff ff       	jmp    80105ac5 <alltraps>
...
80106575:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010657a:	e9 46 f5 ff ff       	jmp    80105ac5 <alltraps>
...
80106581:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106586:	e9 3a f5 ff ff       	jmp    80105ac5 <alltraps>
...
8010658d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106592:	e9 2e f5 ff ff       	jmp    80105ac5 <alltraps>
...
80106599:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010659e:	e9 22 f5 ff ff       	jmp    80105ac5 <alltraps>
...
801065a5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801065aa:	e9 16 f5 ff ff       	jmp    80105ac5 <alltraps>
...
801065b1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801065b6:	e9 0a f5 ff ff       	jmp    80105ac5 <alltraps>
...
801065bd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801065c2:	e9 fe f4 ff ff       	jmp    80105ac5 <alltraps>
...
801065c9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801065ce:	e9 f2 f4 ff ff       	jmp    80105ac5 <alltraps>
...
801065d5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801065da:	e9 e6 f4 ff ff       	jmp    80105ac5 <alltraps>
...
801065e1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801065e6:	e9 da f4 ff ff       	jmp    80105ac5 <alltraps>
...
801065ed:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801065f2:	e9 ce f4 ff ff       	jmp    80105ac5 <alltraps>
...
801065f9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801065fe:	e9 c2 f4 ff ff       	jmp    80105ac5 <alltraps>
...
80106605:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010660a:	e9 b6 f4 ff ff       	jmp    80105ac5 <alltraps>
...
80106611:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106616:	e9 aa f4 ff ff       	jmp    80105ac5 <alltraps>
...
8010661d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106622:	e9 9e f4 ff ff       	jmp    80105ac5 <alltraps>
...
80106629:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010662e:	e9 92 f4 ff ff       	jmp    80105ac5 <alltraps>
...
80106635:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010663a:	e9 86 f4 ff ff       	jmp    80105ac5 <alltraps>
...
80106641:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106646:	e9 7a f4 ff ff       	jmp    80105ac5 <alltraps>
...
8010664d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106652:	e9 6e f4 ff ff       	jmp    80105ac5 <alltraps>
...
80106659:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010665e:	e9 62 f4 ff ff       	jmp    80105ac5 <alltraps>
...
80106665:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010666a:	e9 56 f4 ff ff       	jmp    80105ac5 <alltraps>
...
80106671:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106676:	e9 4a f4 ff ff       	jmp    80105ac5 <alltraps>
...
8010667d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106682:	e9 3e f4 ff ff       	jmp    80105ac5 <alltraps>
...
80106689:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010668e:	e9 32 f4 ff ff       	jmp    80105ac5 <alltraps>
...
80106695:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010669a:	e9 26 f4 ff ff       	jmp    80105ac5 <alltraps>
...
801066a1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801066a6:	e9 1a f4 ff ff       	jmp    80105ac5 <alltraps>
...
801066ad:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801066b2:	e9 0e f4 ff ff       	jmp    80105ac5 <alltraps>
...
801066b9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801066be:	e9 02 f4 ff ff       	jmp    80105ac5 <alltraps>
...
801066c5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801066ca:	e9 f6 f3 ff ff       	jmp    80105ac5 <alltraps>
...
801066d1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801066d6:	e9 ea f3 ff ff       	jmp    80105ac5 <alltraps>
...
801066dd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801066e2:	e9 de f3 ff ff       	jmp    80105ac5 <alltraps>
...
801066e9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801066ee:	e9 d2 f3 ff ff       	jmp    80105ac5 <alltraps>
...
801066f5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801066fa:	e9 c6 f3 ff ff       	jmp    80105ac5 <alltraps>
...
80106701:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106706:	e9 ba f3 ff ff       	jmp    80105ac5 <alltraps>
...
8010670d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106712:	e9 ae f3 ff ff       	jmp    80105ac5 <alltraps>
...
80106719:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010671e:	e9 a2 f3 ff ff       	jmp    80105ac5 <alltraps>
...
80106725:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010672a:	e9 96 f3 ff ff       	jmp    80105ac5 <alltraps>
...
80106731:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106736:	e9 8a f3 ff ff       	jmp    80105ac5 <alltraps>
...
8010673d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106742:	e9 7e f3 ff ff       	jmp    80105ac5 <alltraps>
...
80106749:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010674e:	e9 72 f3 ff ff       	jmp    80105ac5 <alltraps>
...
80106755:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010675a:	e9 66 f3 ff ff       	jmp    80105ac5 <alltraps>
...
80106761:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106766:	e9 5a f3 ff ff       	jmp    80105ac5 <alltraps>
...
8010676d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106772:	e9 4e f3 ff ff       	jmp    80105ac5 <alltraps>
...
80106779:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010677e:	e9 42 f3 ff ff       	jmp    80105ac5 <alltraps>
...
80106785:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010678a:	e9 36 f3 ff ff       	jmp    80105ac5 <alltraps>
...
80106791:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106796:	e9 2a f3 ff ff       	jmp    80105ac5 <alltraps>
...
8010679d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801067a2:	e9 1e f3 ff ff       	jmp    80105ac5 <alltraps>
...
801067a9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801067ae:	e9 12 f3 ff ff       	jmp    80105ac5 <alltraps>
...
801067b5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801067ba:	e9 06 f3 ff ff       	jmp    80105ac5 <alltraps>
...
801067c1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801067c6:	e9 fa f2 ff ff       	jmp    80105ac5 <alltraps>
...
801067cd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801067d2:	e9 ee f2 ff ff       	jmp    80105ac5 <alltraps>
...
801067d9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801067de:	e9 e2 f2 ff ff       	jmp    80105ac5 <alltraps>
...
801067e5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801067ea:	e9 d6 f2 ff ff       	jmp    80105ac5 <alltraps>
...
801067f1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801067f6:	e9 ca f2 ff ff       	jmp    80105ac5 <alltraps>
...
801067fd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106802:	e9 be f2 ff ff       	jmp    80105ac5 <alltraps>
...
80106809:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010680e:	e9 b2 f2 ff ff       	jmp    80105ac5 <alltraps>
...
80106815:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010681a:	e9 a6 f2 ff ff       	jmp    80105ac5 <alltraps>
...
80106821:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106826:	e9 9a f2 ff ff       	jmp    80105ac5 <alltraps>
...
8010682d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106832:	e9 8e f2 ff ff       	jmp    80105ac5 <alltraps>
...
80106839:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010683e:	e9 82 f2 ff ff       	jmp    80105ac5 <alltraps>
...
80106845:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010684a:	e9 76 f2 ff ff       	jmp    80105ac5 <alltraps>
...
80106851:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106856:	e9 6a f2 ff ff       	jmp    80105ac5 <alltraps>
...
8010685d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106862:	e9 5e f2 ff ff       	jmp    80105ac5 <alltraps>
...
80106869:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010686e:	e9 52 f2 ff ff       	jmp    80105ac5 <alltraps>
...
80106875:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010687a:	e9 46 f2 ff ff       	jmp    80105ac5 <alltraps>
...
80106881:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106886:	e9 3a f2 ff ff       	jmp    80105ac5 <alltraps>
...
8010688d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106892:	e9 2e f2 ff ff       	jmp    80105ac5 <alltraps>
...
80106899:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010689e:	e9 22 f2 ff ff       	jmp    80105ac5 <alltraps>
...
801068a5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801068aa:	e9 16 f2 ff ff       	jmp    80105ac5 <alltraps>
...
801068b1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801068b6:	e9 0a f2 ff ff       	jmp    80105ac5 <alltraps>
...
801068bd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801068c2:	e9 fe f1 ff ff       	jmp    80105ac5 <alltraps>
...
801068c9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801068ce:	e9 f2 f1 ff ff       	jmp    80105ac5 <alltraps>
...
801068d5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801068da:	e9 e6 f1 ff ff       	jmp    80105ac5 <alltraps>
...
801068e1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801068e6:	e9 da f1 ff ff       	jmp    80105ac5 <alltraps>
...
801068ed:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801068f2:	e9 ce f1 ff ff       	jmp    80105ac5 <alltraps>
...
801068f9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801068fe:	e9 c2 f1 ff ff       	jmp    80105ac5 <alltraps>
...
80106905:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010690a:	e9 b6 f1 ff ff       	jmp    80105ac5 <alltraps>
...
80106911:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106916:	e9 aa f1 ff ff       	jmp    80105ac5 <alltraps>
...
8010691d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106922:	e9 9e f1 ff ff       	jmp    80105ac5 <alltraps>
...
80106929:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010692e:	e9 92 f1 ff ff       	jmp    80105ac5 <alltraps>
...
80106935:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010693a:	e9 86 f1 ff ff       	jmp    80105ac5 <alltraps>
...
80106941:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106946:	e9 7a f1 ff ff       	jmp    80105ac5 <alltraps>
...
8010694d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106952:	e9 6e f1 ff ff       	jmp    80105ac5 <alltraps>
...
80106959:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010695e:	e9 62 f1 ff ff       	jmp    80105ac5 <alltraps>
...
80106965:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010696a:	e9 56 f1 ff ff       	jmp    80105ac5 <alltraps>
...
80106971:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106976:	e9 4a f1 ff ff       	jmp    80105ac5 <alltraps>
...
8010697d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106982:	e9 3e f1 ff ff       	jmp    80105ac5 <alltraps>
...
80106989:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010698e:	e9 32 f1 ff ff       	jmp    80105ac5 <alltraps>
...
80106995:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010699a:	e9 26 f1 ff ff       	jmp    80105ac5 <alltraps>
...
801069a1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801069a6:	e9 1a f1 ff ff       	jmp    80105ac5 <alltraps>
...
801069ad:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801069b2:	e9 0e f1 ff ff       	jmp    80105ac5 <alltraps>
...
801069b9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801069be:	e9 02 f1 ff ff       	jmp    80105ac5 <alltraps>
...
801069c5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801069ca:	e9 f6 f0 ff ff       	jmp    80105ac5 <alltraps>
...
801069d1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801069d6:	e9 ea f0 ff ff       	jmp    80105ac5 <alltraps>
...
801069dd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801069e2:	e9 de f0 ff ff       	jmp    80105ac5 <alltraps>
...
801069e9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801069ee:	e9 d2 f0 ff ff       	jmp    80105ac5 <alltraps>
...
801069f5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801069fa:	e9 c6 f0 ff ff       	jmp    80105ac5 <alltraps>
...
80106a01:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106a06:	e9 ba f0 ff ff       	jmp    80105ac5 <alltraps>
...
80106a0d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106a12:	e9 ae f0 ff ff       	jmp    80105ac5 <alltraps>
...
80106a19:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106a1e:	e9 a2 f0 ff ff       	jmp    80105ac5 <alltraps>
...
80106a25:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106a2a:	e9 96 f0 ff ff       	jmp    80105ac5 <alltraps>
...
80106a31:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106a36:	e9 8a f0 ff ff       	jmp    80105ac5 <alltraps>
...
80106a3d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106a42:	e9 7e f0 ff ff       	jmp    80105ac5 <alltraps>
...
80106aef:	68 a6 78 10 80       	push   $0x801078a6
...
80106b7e:	e8 7d bb ff ff       	call   80102700 <kalloc>
...
80106b95:	e8 16 dd ff ff       	call   801048b0 <memset>
...
80106bdd:	68 60 7f 10 80       	push   $0x80107f60
...
80106c0a:	c7 80 18 a8 14 80 ff 	movl   $0xffff,-0x7feb57e8(%eax)
80106c11:	ff 00 00 
80106c14:	c7 80 1c a8 14 80 00 	movl   $0xcf9a00,-0x7feb57e4(%eax)
80106c1b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106c1e:	c7 80 20 a8 14 80 ff 	movl   $0xffff,-0x7feb57e0(%eax)
80106c25:	ff 00 00 
80106c28:	c7 80 24 a8 14 80 00 	movl   $0xcf9200,-0x7feb57dc(%eax)
80106c2f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106c32:	c7 80 28 a8 14 80 ff 	movl   $0xffff,-0x7feb57d8(%eax)
80106c39:	ff 00 00 
80106c3c:	c7 80 2c a8 14 80 00 	movl   $0xcffa00,-0x7feb57d4(%eax)
80106c43:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106c46:	c7 80 30 a8 14 80 ff 	movl   $0xffff,-0x7feb57d0(%eax)
80106c4d:	ff 00 00 
80106c50:	c7 80 34 a8 14 80 00 	movl   $0xcff200,-0x7feb57cc(%eax)
80106c57:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106c5a:	05 10 a8 14 80       	add    $0x8014a810,%eax
  pd[1] = (uint)p;
...
80106c80:	a1 c4 d4 14 80       	mov    0x8014d4c4,%eax
...
80106cb4:	0f 84 c2 00 00 00    	je     80106d7c <switchuvm+0xec>
  pushcli();
80106cba:	e8 e1 d9 ff ff       	call   801046a0 <pushcli>
...
80106dbb:	77 4b                	ja     80106e08 <inituvm+0x68>
  mem = kalloc();
80106dbd:	e8 3e b9 ff ff       	call   80102700 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106dcf:	e8 dc da ff ff       	call   801048b0 <memset>
...
80106e02:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106e03:	e9 48 db ff ff       	jmp    80104950 <memmove>
    panic("inituvm: more than a page");
80106e08:	83 ec 0c             	sub    $0xc,%esp
80106e0b:	68 a5 7f 10 80       	push   $0x80107fa5
...
80106e70:	68 bf 7f 10 80       	push   $0x80107fbf
...
80106ef8:	68 cc 80 10 80       	push   $0x801080cc
...
80106f5b:	e8 50 d9 ff ff       	call   801048b0 <memset>
...
80106f89:	76 48                	jbe    80106fd3 <allocuvm+0xc3>
    mem = kalloc();
80106f8b:	e8 70 b7 ff ff       	call   80102700 <kalloc>
...
80106f99:	68 dd 7f 10 80       	push   $0x80107fdd
...
80106ffb:	68 f5 7f 10 80       	push   $0x80107ff5
...
801070dc:	68 11 80 10 80       	push   $0x80108011
...
801070f5:	e8 06 b6 ff ff       	call   80102700 <kalloc>
...
8010717b:	a3 c4 d4 14 80       	mov    %eax,0x8014d4c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801071ac:	68 22 80 10 80       	push   $0x80108022
...
801071f2:	0f 84 aa 00 00 00    	je     801072a2 <copyuvm+0xc2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801071f8:	8b 45 0c             	mov    0xc(%ebp),%eax
801071fb:	85 c0                	test   %eax,%eax
801071fd:	0f 84 93 00 00 00    	je     80107296 <copyuvm+0xb6>
80107203:	31 ff                	xor    %edi,%edi
80107205:	8d 76 00             	lea    0x0(%esi),%esi
  if(*pde & PTE_P){
80107208:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
8010720b:	89 f8                	mov    %edi,%eax
8010720d:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80107210:	8b 04 82             	mov    (%edx,%eax,4),%eax
80107213:	a8 01                	test   $0x1,%al
80107215:	75 11                	jne    80107228 <copyuvm+0x48>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80107217:	83 ec 0c             	sub    $0xc,%esp
8010721a:	68 2c 80 10 80       	push   $0x8010802c
8010721f:	e8 5c 91 ff ff       	call   80100380 <panic>
80107224:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  return &pgtab[PTX(va)];
80107228:	89 f9                	mov    %edi,%ecx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010722a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
8010722f:	c1 e9 0a             	shr    $0xa,%ecx
80107232:	81 e1 fc 0f 00 00    	and    $0xffc,%ecx
80107238:	8d 8c 08 00 00 00 80 	lea    -0x80000000(%eax,%ecx,1),%ecx
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010723f:	85 c9                	test   %ecx,%ecx
80107241:	74 d4                	je     80107217 <copyuvm+0x37>
    if(!(*pte & PTE_P))
80107243:	8b 01                	mov    (%ecx),%eax
80107245:	a8 01                	test   $0x1,%al
80107247:	0f 84 93 00 00 00    	je     801072e0 <copyuvm+0x100>
...
80107252:	89 fa                	mov    %edi,%edx
	*pte &= ~PTE_W;
80107254:	83 e3 fd             	and    $0xfffffffd,%ebx
80107257:	89 19                	mov    %ebx,(%ecx)
    pa = PTE_ADDR(*pte);
80107259:	89 c3                	mov    %eax,%ebx
    flags = PTE_FLAGS(*pte);
8010725b:	25 fd 0f 00 00       	and    $0xffd,%eax
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80107260:	b9 00 10 00 00       	mov    $0x1000,%ecx
    pa = PTE_ADDR(*pte);
80107265:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
8010726b:	50                   	push   %eax
8010726c:	89 f0                	mov    %esi,%eax
8010726e:	53                   	push   %ebx
8010726f:	e8 8c f8 ff ff       	call   80106b00 <mappages>
80107274:	83 c4 10             	add    $0x10,%esp
80107277:	85 c0                	test   %eax,%eax
80107279:	78 35                	js     801072b0 <copyuvm+0xd0>
      //kfree(mem);
...
8010727b:	83 ec 0c             	sub    $0xc,%esp
  for(i = 0; i < sz; i += PGSIZE){
8010727e:	81 c7 00 10 00 00    	add    $0x1000,%edi
	incr_refc(pa);
80107284:	53                   	push   %ebx
80107285:	e8 06 b5 ff ff       	call   80102790 <incr_refc>
  for(i = 0; i < sz; i += PGSIZE){
8010728a:	83 c4 10             	add    $0x10,%esp
8010728d:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80107290:	0f 87 72 ff ff ff    	ja     80107208 <copyuvm+0x28>
  }
  lcr3(V2P(pgdir));
80107296:	8b 45 08             	mov    0x8(%ebp),%eax
80107299:	8d b8 00 00 00 80    	lea    -0x80000000(%eax),%edi
8010729f:	0f 22 df             	mov    %edi,%cr3
...
801072b3:	68 60 80 10 80       	push   $0x80108060
801072b8:	e8 e3 93 ff ff       	call   801006a0 <cprintf>
  freevm(d);
801072bd:	89 34 24             	mov    %esi,(%esp)
801072c0:	e8 ab fd ff ff       	call   80107070 <freevm>
  lcr3(V2P(pgdir));
801072c5:	8b 45 08             	mov    0x8(%ebp),%eax
801072c8:	8d b8 00 00 00 80    	lea    -0x80000000(%eax),%edi
801072ce:	0f 22 df             	mov    %edi,%cr3
  return 0;
801072d1:	31 f6                	xor    %esi,%esi
801072d3:	83 c4 10             	add    $0x10,%esp
}
801072d6:	8d 65 f4             	lea    -0xc(%ebp),%esp
801072d9:	5b                   	pop    %ebx
801072da:	89 f0                	mov    %esi,%eax
801072dc:	5e                   	pop    %esi
801072dd:	5f                   	pop    %edi
801072de:	5d                   	pop    %ebp
801072df:	c3                   	ret    
...
801072e3:	68 46 80 10 80       	push   $0x80108046
801072e8:	e8 93 90 ff ff       	call   80100380 <panic>
...
80107304:	0f 84 1e 03 00 00    	je     80107628 <uva2ka.cold>
  return &pgtab[PTX(va)];
...
80107390:	e8 bb d5 ff ff       	call   80104950 <memmove>
    len -= n;
    buf += n;
...
801073bd:	0f 84 6c 02 00 00    	je     8010762f <copyout.cold>
  return &pgtab[PTX(va)];
...
80107416:	83 ec 1c             	sub    $0x1c,%esp
  asm volatile("movl %%cr2,%0" : "=r" (val));
80107419:	0f 20 d6             	mov    %cr2,%esi
  uint fva = rcr2();
  pte_t *pte;
  uint pa;
  char *mem;
  struct proc *p = myproc();
8010741c:	e8 8f c7 ff ff       	call   80103bb0 <myproc>
  
  if(p == 0)
80107421:	85 c0                	test   %eax,%eax
80107423:	0f 84 ca 00 00 00    	je     801074f3 <CoW_handler+0xe3>
80107429:	89 c3                	mov    %eax,%ebx
  pde = &pgdir[PDX(va)];
8010742b:	89 f2                	mov    %esi,%edx
  if(*pde & PTE_P){
8010742d:	8b 40 04             	mov    0x4(%eax),%eax
  pde = &pgdir[PDX(va)];
80107430:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80107433:	8b 04 90             	mov    (%eax,%edx,4),%eax
80107436:	a8 01                	test   $0x1,%al
80107438:	0f 84 a8 00 00 00    	je     801074e6 <CoW_handler+0xd6>
  return &pgtab[PTX(va)];
8010743e:	89 f2                	mov    %esi,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107440:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80107445:	c1 ea 0a             	shr    $0xa,%edx
80107448:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
8010744e:	8d bc 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%edi
	panic("CoW_handler: No proc");

  if((pte = walkpgdir(p->pgdir, (void*)fva, 0)) == 0)
80107455:	85 ff                	test   %edi,%edi
80107457:	0f 84 89 00 00 00    	je     801074e6 <CoW_handler+0xd6>
	panic("CoW_handler: pte should exist");
  if(!(*pte & PTE_P)){
8010745d:	f6 07 01             	testb  $0x1,(%edi)
80107460:	0f 84 9a 00 00 00    	je     80107500 <CoW_handler+0xf0>
	panic("CoW_handler: page not present");
  }

  int refc = get_refc(V2P(fva));
80107466:	83 ec 0c             	sub    $0xc,%esp
80107469:	81 c6 00 00 00 80    	add    $0x80000000,%esi
8010746f:	56                   	push   %esi
80107470:	e8 fb b3 ff ff       	call   80102870 <get_refc>
  if(refc == 1){ // cause: parent try to write on read-only page
80107475:	83 c4 10             	add    $0x10,%esp
80107478:	83 f8 01             	cmp    $0x1,%eax
8010747b:	74 1b                	je     80107498 <CoW_handler+0x88>
	*pte |= PTE_W;
  }
  else if(refc > 1){ // cause: child needs copy page
8010747d:	7f 21                	jg     801074a0 <CoW_handler+0x90>
  ...
  lcr3(V2P(p->pgdir));
8010747f:	8b 43 04             	mov    0x4(%ebx),%eax
80107482:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
...
80107492:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	*pte |= PTE_W;
80107498:	83 0f 02             	orl    $0x2,(%edi)
8010749b:	eb e2                	jmp    8010747f <CoW_handler+0x6f>
8010749d:	8d 76 00             	lea    0x0(%esi),%esi
	pa = PTE_ADDR(*pte);
801074a0:	8b 37                	mov    (%edi),%esi
	if((mem = kalloc()) == 0)
801074a2:	e8 59 b2 ff ff       	call   80102700 <kalloc>
801074a7:	89 c2                	mov    %eax,%edx
801074a9:	85 c0                	test   %eax,%eax
801074ab:	74 dd                	je     8010748a <CoW_handler+0x7a>
	pa = PTE_ADDR(*pte);
801074ad:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
	memmove(mem, (char*)P2V(pa), PGSIZE);
801074b3:	83 ec 04             	sub    $0x4,%esp
801074b6:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801074b9:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801074bf:	68 00 10 00 00       	push   $0x1000
801074c4:	50                   	push   %eax
801074c5:	52                   	push   %edx
801074c6:	e8 85 d4 ff ff       	call   80104950 <memmove>
	*pte = V2P(mem) | PTE_P | PTE_U | PTE_W;
801074cb:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801074ce:	81 c2 00 00 00 80    	add    $0x80000000,%edx
801074d4:	83 ca 07             	or     $0x7,%edx
801074d7:	89 17                	mov    %edx,(%edi)
	decr_refc(pa);
801074d9:	89 34 24             	mov    %esi,(%esp)
801074dc:	e8 1f b3 ff ff       	call   80102800 <decr_refc>
801074e1:	83 c4 10             	add    $0x10,%esp
801074e4:	eb 99                	jmp    8010747f <CoW_handler+0x6f>
	panic("CoW_handler: pte should exist");
801074e6:	83 ec 0c             	sub    $0xc,%esp
801074e9:	68 8f 80 10 80       	push   $0x8010808f
801074ee:	e8 8d 8e ff ff       	call   80100380 <panic>
	panic("CoW_handler: No proc");
801074f3:	83 ec 0c             	sub    $0xc,%esp
801074f6:	68 7a 80 10 80       	push   $0x8010807a
801074fb:	e8 80 8e ff ff       	call   80100380 <panic>
	panic("CoW_handler: page not present");
80107500:	83 ec 0c             	sub    $0xc,%esp
80107503:	68 ad 80 10 80       	push   $0x801080ad
80107508:	e8 73 8e ff ff       	call   80100380 <panic>
...
80107513:	83 ec 08             	sub    $0x8,%esp
  struct proc *p = myproc();
80107516:	e8 95 c6 ff ff       	call   80103bb0 <myproc>
  if(p == 0)
8010751b:	85 c0                	test   %eax,%eax
8010751d:	74 1f                	je     8010753e <scountvp+0x2e>
	return -1;
...
8010751f:	8b 08                	mov    (%eax),%ecx
  int count = 0;
80107521:	31 c0                	xor    %eax,%eax
  for(; va < p->sz; va += PGSIZE)
80107523:	85 c9                	test   %ecx,%ecx
80107525:	74 15                	je     8010753c <scountvp+0x2c>
80107527:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010752e:	66 90                	xchg   %ax,%ax
	count++;
80107530:	83 c0 01             	add    $0x1,%eax
  for(; va < p->sz; va += PGSIZE)
80107533:	89 c2                	mov    %eax,%edx
80107535:	c1 e2 0c             	shl    $0xc,%edx
80107538:	39 ca                	cmp    %ecx,%edx
8010753a:	72 f4                	jb     80107530 <scountvp+0x20>
  return count;
}
8010753c:	c9                   	leave  
8010753d:	c3                   	ret    
...
80107544:	c3                   	ret    
80107545:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80107556:	83 ec 0c             	sub    $0xc,%esp
  struct proc *p = myproc();
80107559:	e8 52 c6 ff ff       	call   80103bb0 <myproc>
  if(p == 0)
8010755e:	85 c0                	test   %eax,%eax
80107560:	74 6a                	je     801075cc <scountpp+0x7c>
  ...
  for(; va < p->sz; va += PGSIZE){
80107562:	8b 18                	mov    (%eax),%ebx
80107564:	85 db                	test   %ebx,%ebx
80107566:	74 58                	je     801075c0 <scountpp+0x70>
	// if pte exists & present, incr count
	if((pte = walkpgdir(p->pgdir, (void*)va, 0)) != 0 && (*pte & PTE_P))
80107568:	8b 70 04             	mov    0x4(%eax),%esi
  int count = 0;
8010756b:	31 c9                	xor    %ecx,%ecx
  uint va = 0;
8010756d:	31 c0                	xor    %eax,%eax
8010756f:	90                   	nop
  pde = &pgdir[PDX(va)];
80107570:	89 c2                	mov    %eax,%edx
80107572:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80107575:	8b 14 96             	mov    (%esi,%edx,4),%edx
80107578:	f6 c2 01             	test   $0x1,%dl
8010757b:	74 27                	je     801075a4 <scountpp+0x54>
  return &pgtab[PTX(va)];
8010757d:	89 c7                	mov    %eax,%edi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010757f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80107585:	c1 ef 0a             	shr    $0xa,%edi
80107588:	81 e7 fc 0f 00 00    	and    $0xffc,%edi
8010758e:	8d 94 3a 00 00 00 80 	lea    -0x80000000(%edx,%edi,1),%edx
	if((pte = walkpgdir(p->pgdir, (void*)va, 0)) != 0 && (*pte & PTE_P))
80107595:	85 d2                	test   %edx,%edx
80107597:	74 0b                	je     801075a4 <scountpp+0x54>
80107599:	8b 12                	mov    (%edx),%edx
8010759b:	83 e2 01             	and    $0x1,%edx
	  count++;
8010759e:	83 fa 01             	cmp    $0x1,%edx
801075a1:	83 d9 ff             	sbb    $0xffffffff,%ecx
  for(; va < p->sz; va += PGSIZE){
801075a4:	05 00 10 00 00       	add    $0x1000,%eax
801075a9:	39 c3                	cmp    %eax,%ebx
801075ab:	77 c3                	ja     80107570 <scountpp+0x20>
  }

  return count;
}
801075ad:	83 c4 0c             	add    $0xc,%esp
801075b0:	89 c8                	mov    %ecx,%eax
801075b2:	5b                   	pop    %ebx
801075b3:	5e                   	pop    %esi
801075b4:	5f                   	pop    %edi
801075b5:	5d                   	pop    %ebp
...
801075c0:	83 c4 0c             	add    $0xc,%esp
  int count = 0;
801075c3:	31 c9                	xor    %ecx,%ecx
}
801075c5:	5b                   	pop    %ebx
801075c6:	89 c8                	mov    %ecx,%eax
801075c8:	5e                   	pop    %esi
801075c9:	5f                   	pop    %edi
801075ca:	5d                   	pop    %ebp
801075cb:	c3                   	ret    
	return -1;
801075cc:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
801075d1:	eb da                	jmp    801075ad <scountpp+0x5d>
...
801075e4:	83 ec 04             	sub    $0x4,%esp
  struct proc *p = myproc();
801075e7:	e8 c4 c5 ff ff       	call   80103bb0 <myproc>
  if(p == 0)
801075ec:	85 c0                	test   %eax,%eax
801075ee:	74 31                	je     80107621 <scountptp+0x41>
  int count = 0;
  uint pdx;
...
801075f0:	8b 58 04             	mov    0x4(%eax),%ebx
801075f3:	8b 03                	mov    (%ebx),%eax
801075f5:	8d 53 04             	lea    0x4(%ebx),%edx
801075f8:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801075fe:	89 c1                	mov    %eax,%ecx
80107600:	83 e1 01             	and    $0x1,%ecx
80107603:	eb 08                	jmp    8010760d <scountptp+0x2d>
80107605:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(pdx = 0; pdx < NPDENTRIES; pdx++){
	pde = &p->pgdir[pdx];
	if(*pde & PTE_P) count++;
80107608:	8b 02                	mov    (%edx),%eax
8010760a:	83 c2 04             	add    $0x4,%edx
8010760d:	83 e0 01             	and    $0x1,%eax
80107610:	83 f8 01             	cmp    $0x1,%eax
80107613:	83 d9 ff             	sbb    $0xffffffff,%ecx
  for(pdx = 0; pdx < NPDENTRIES; pdx++){
80107616:	39 da                	cmp    %ebx,%edx
80107618:	75 ee                	jne    80107608 <scountptp+0x28>
  }
...
80107620:	c3                   	ret    
	return -1;
80107621:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
80107626:	eb f2                	jmp    8010761a <scountptp+0x3a>

80107628 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80107628:	a1 00 00 00 00       	mov    0x0,%eax
8010762d:	0f 0b                	ud2    

8010762f <copyout.cold>:
8010762f:	a1 00 00 00 00       	mov    0x0,%eax
80107634:	0f 0b                	ud2    
