  ...
  10:	31 db                	xor    %ebx,%ebx
{
  ...
  int parent_initial_fp = countfp();
  22:	e8 bc 03 00 00       	call   3e3 <countfp>
  27:	83 c4 10             	add    $0x10,%esp
  2a:	89 c6                	mov    %eax,%esi
  for(int i = 0; i < 10; i++){
  2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    pid = fork();
  30:	e8 06 03 00 00       	call   33b <fork>
    if(pid == 0){
  35:	85 c0                	test   %eax,%eax
  37:	74 5e                	je     97 <main+0x97>
  for(int i = 0; i < 10; i++){
  ...
  for(int i = 0; i < 10; i++){
    wait();
  48:	e8 fe 02 00 00       	call   34b <wait>
  for(int i = 0; i < 10; i++){
  ...
  52:	e8 8c 03 00 00       	call   3e3 <countfp>
  57:	39 f0                	cmp    %esi,%eax
  59:	74 29                	je     84 <main+0x84>
	printf(1, "fp comp: %d %d\n", parent_initial_fp, countfp());
  5b:	e8 83 03 00 00       	call   3e3 <countfp>
  60:	50                   	push   %eax
  61:	56                   	push   %esi
  62:	68 27 08 00 00       	push   $0x827
  67:	6a 01                	push   $0x1
  69:	e8 52 04 00 00       	call   4c0 <printf>
    printf(1, "[Test 3] fail\n\n");
  6e:	5a                   	pop    %edx
  6f:	59                   	pop    %ecx
  70:	68 17 08 00 00       	push   $0x817
  75:	6a 01                	push   $0x1
  77:	e8 44 04 00 00       	call   4c0 <printf>
  7c:	83 c4 10             	add    $0x10,%esp
      exit();
  7f:	e8 bf 02 00 00       	call   343 <exit>
  }
  else
    printf(1, "[Test 3] pass\n\n");
  84:	50                   	push   %eax
  85:	50                   	push   %eax
  86:	68 37 08 00 00       	push   $0x837
  8b:	6a 01                	push   $0x1
  8d:	e8 2e 04 00 00       	call   4c0 <printf>
  92:	83 c4 10             	add    $0x10,%esp
  95:	eb e8                	jmp    7f <main+0x7f>
      sleep(100 + 50 * i);
  97:	6b c3 32             	imul   $0x32,%ebx,%eax
  9a:	83 ec 0c             	sub    $0xc,%esp
  9d:	83 c0 64             	add    $0x64,%eax
  a0:	50                   	push   %eax
  a1:	e8 2d 03 00 00       	call   3d3 <sleep>
      int child_initial_fp = countfp();
  a6:	e8 38 03 00 00       	call   3e3 <countfp>
      initial_data = 1;
  ab:	c7 05 60 0b 00 00 01 	movl   $0x1,0xb60
  b2:	00 00 00 
      int child_initial_fp = countfp();
  b5:	89 c7                	mov    %eax,%edi
      int child_modified_fp = countfp();
  b7:	e8 27 03 00 00       	call   3e3 <countfp>
  bc:	89 c6                	mov    %eax,%esi
      printf(1, "child [%d]'s result: %d\n", i,child_initial_fp - child_modified_fp);
  be:	89 f8                	mov    %edi,%eax
  c0:	29 f0                	sub    %esi,%eax
  c2:	50                   	push   %eax
  c3:	53                   	push   %ebx
  c4:	68 fe 07 00 00       	push   $0x7fe
  c9:	6a 01                	push   $0x1
  cb:	e8 f0 03 00 00       	call   4c0 <printf>
      if((child_initial_fp - child_modified_fp) == 0)
  d0:	83 c4 20             	add    $0x20,%esp
  d3:	39 f7                	cmp    %esi,%edi
  d5:	75 a8                	jne    7f <main+0x7f>
        printf(1, "[Test 3] fail\n\n");
  d7:	53                   	push   %ebx
  d8:	53                   	push   %ebx
  d9:	68 17 08 00 00       	push   $0x817
  de:	6a 01                	push   $0x1
  e0:	e8 db 03 00 00       	call   4c0 <printf>
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 a8 08 00 00 	movzbl 0x8a8(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 50 08 00 00 	jmp    *0x850(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 47 08 00 00       	mov    $0x847,%edx
        while(*s != 0){
 ...
 661:	a1 64 0b 00 00       	mov    0xb64,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 64 0b 00 00    	mov    %edx,0xb64
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 64 0b 00 00    	mov    %edx,0xb64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 64 0b 00 00    	mov    0xb64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 64 0b 00 00    	mov    0xb64,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 64 0b 00 00    	mov    0xb64,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 64 0b 00 00    	mov    %edx,0xb64
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 64 0b 00 00 68 	movl   $0xb68,0xb64
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 68 0b 00 00       	mov    $0xb68,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 68 0b 00 00 68 	movl   $0xb68,0xb68
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 6c 0b 00 00 00 	movl   $0x0,0xb6c
 7d2:	00 00 00 
    if(p->s.size >= nunits){
