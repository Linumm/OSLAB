...
main(int argc, char *argv[])
{
  ...
  1e:	e8 80 03 00 00       	call   3a3 <countfp>
  23:	83 c4 0c             	add    $0xc,%esp
  26:	50                   	push   %eax
  27:	68 be 07 00 00       	push   $0x7be
  2c:	6a 01                	push   $0x1
  2e:	e8 4d 04 00 00       	call   480 <printf>
  ...
  6d:	eb 1b                	jmp    8a <main+0x8a>
    ...
    wait();
  6f:	e8 97 02 00 00       	call   30b <wait>
	printf(1, "After fp: %d\n", countfp());
  74:	e8 2a 03 00 00       	call   3a3 <countfp>
  79:	52                   	push   %edx
  7a:	50                   	push   %eax
  7b:	68 ed 07 00 00       	push   $0x7ed
  80:	6a 01                	push   $0x1
  ...
  8f:	53                   	push   %ebx
  90:	53                   	push   %ebx
  91:	68 cd 07 00 00       	push   $0x7cd
  96:	6a 01                	push   $0x1
  98:	e8 e3 03 00 00       	call   480 <printf>
  9d:	83 c4 10             	add    $0x10,%esp
  a0:	eb e8                	jmp    8a <main+0x8a>
  a2:	66 90                	xchg   %ax,%ax
  a4:	66 90                	xchg   %ax,%ax
  a6:	66 90                	xchg   %ax,%ax
  a8:	66 90                	xchg   %ax,%ax
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 5c 08 00 00 	movzbl 0x85c(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 04 08 00 00 	jmp    *0x804(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba fb 07 00 00       	mov    $0x7fb,%edx
        while(*s != 0){
 ...
 621:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 ...
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 10 0b 00 00       	mov    $0xb10,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 786:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 792:	00 00 00 
    if(p->s.size >= nunits){
